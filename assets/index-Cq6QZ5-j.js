...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
}`;function eM(n,e,t){let i=new fl;const r=new Ae,s=new Ae,a=new yt,o=new Sh({depthPacking:th}),l=new Zx,c={},u=t.maxTextureSize,f={[di]:Wt,[Wt]:di,[vn]:vn},h=new Vt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ae},radius:{value:4}},vertexShader:Jx,fragmentShader:Qx}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const x=new an;x.setAttribute("position",new En(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new kt(x,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Wf;let d=this.type;this.render=function(C,w,$){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||C.length===0)return;const T=n.getRenderTarget(),A=n.getActiveCubeFace(),Y=n.getActiveMipmapLevel(),te=n.state;te.setBlending(Sn),te.buffers.color.setClear(1,1,1,1),te.buffers.depth.setTest(!0),te.setScissorTest(!1);const le=d!==Bn&&this.type===Bn,I=d===Bn&&this.type!==Bn;for(let V=0,W=C.length;V<W;V++){const O=C[V],G=O.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",O,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const k=G.getFrameExtents();if(r.multiply(k),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/k.x),r.x=s.x*k.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/k.y),r.y=s.y*k.y,G.mapSize.y=s.y)),G.map===null||le===!0||I===!0){const ue=this.type!==Bn?{minFilter:Ft,magFilter:Ft}:{};G.map!==null&&G.map.dispose(),G.map=new Bt(r.x,r.y,ue),G.map.texture.name=O.name+".shadowMap",G.camera.updateProjectionMatrix()}n.setRenderTarget(G.map),n.clear();const ne=G.getViewportCount();for(let ue=0;ue<ne;ue++){const ce=G.getViewport(ue);a.set(s.x*ce.x,s.y*ce.y,s.x*ce.z,s.y*ce.w),te.viewport(a),G.updateMatrices(O,ue),i=G.getFrustum(),E(w,$,G.camera,O,this.type)}G.isPointLightShadow!==!0&&this.type===Bn&&y(G,$),G.needsUpdate=!1}d=this.type,p.needsUpdate=!1,n.setRenderTarget(T,A,Y)};function y(C,w){const $=e.update(_);h.defines.VSM_SAMPLES!==C.blurSamples&&(h.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Bt(r.x,r.y)),h.uniforms.shadow_pass.value=C.map.texture,h.uniforms.resolution.value=C.mapSize,h.uniforms.radius.value=C.radius,n.setRenderTarget(C.mapPass),n.clear(),n.renderBufferDirect(w,null,$,h,_,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,n.setRenderTarget(C.map),n.clear(),n.renderBufferDirect(w,null,$,m,_,null)}function S(C,w,$,T){let A=null;const Y=$.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(Y!==void 0)A=Y;else if(A=$.isPointLight===!0?l:o,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const te=A.uuid,le=w.uuid;let I=c[te];I===void 0&&(I={},c[te]=I);let V=I[le];V===void 0&&(V=A.clone(),I[le]=V,w.addEventListener("dispose",D)),A=V}if(A.visible=w.visible,A.wireframe=w.wireframe,T===Bn?A.side=w.shadowSide!==null?w.shadowSide:w.side:A.side=w.shadowSide!==null?w.shadowSide:f[w.side],A.alphaMap=w.alphaMap,A.alphaTest=w.alphaTest,A.map=w.map,A.clipShadows=w.clipShadows,A.clippingPlanes=w.clippingPlanes,A.clipIntersection=w.clipIntersection,A.displacementMap=w.displacementMap,A.displacementScale=w.displacementScale,A.displacementBias=w.displacementBias,A.wireframeLinewidth=w.wireframeLinewidth,A.linewidth=w.linewidth,$.isPointLight===!0&&A.isMeshDistanceMaterial===!0){const te=n.properties.get(A);te.light=$}return A}function E(C,w,$,T,A){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&A===Bn)&&(!C.frustumCulled||i.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,C.matrixWorld);const le=e.update(C),I=C.material;if(Array.isArray(I)){const V=le.groups;for(let W=0,O=V.length;W<O;W++){const G=V[W],k=I[G.materialIndex];if(k&&k.visible){const ne=S(C,k,T,A);C.onBeforeShadow(n,C,w,$,le,ne,G),n.renderBufferDirect($,null,le,ne,C,G),C.onAfterShadow(n,C,w,$,le,ne,G)}}}else if(I.visible){const V=S(C,I,T,A);C.onBeforeShadow(n,C,w,$,le,V,null),n.renderBufferDirect($,null,le,V,C,null),C.onAfterShadow(n,C,w,$,le,V,null)}}const te=C.children;for(let le=0,I=te.length;le<I;le++)E(te[le],w,$,T,A)}function D(C){C.target.removeEventListener("dispose",D);for(const $ in c){const T=c[$],A=C.target.uuid;A in T&&(T[A].dispose(),delete T[A])}}}function tM(n,e,t){const i=t.isWebGL2;function r(){let U=!1;const pe=new yt;let Me=null;const Fe=new yt(0,0,0,0);return{setMask:function(De){Me!==De&&!U&&(n.colorMask(De,De,De,De),Me=De)},setLocked:function(De){U=De},setClear:function(De,Ze,Je,ct,ht){ht===!0&&(De*=ct,Ze*=ct,Je*=ct),pe.set(De,Ze,Je,ct),Fe.equals(pe)===!1&&(n.clearColor(De,Ze,Je,ct),Fe.copy(pe))},reset:function(){U=!1,Me=null,Fe.set(-1,0,0,0)}}}function s(){let U=!1,pe=null,Me=null,Fe=null;return{setTest:function(De){De?Oe(n.DEPTH_TEST):me(n.DEPTH_TEST)},setMask:function(De){pe!==De&&!U&&(n.depthMask(De),pe=De)},setFunc:function(De){if(Me!==De){switch(De){case bm:n.depthFunc(n.NEVER);break;case Am:n.depthFunc(n.ALWAYS);break;case wm:n.depthFunc(n.LESS);break;case Ks:n.depthFunc(n.LEQUAL);break;case Rm:n.depthFunc(n.EQUAL);break;case Cm:n.depthFunc(n.GEQUAL);break;case Pm:n.depthFunc(n.GREATER);break;case Lm:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}Me=De}},setLocked:function(De){U=De},setClear:function(De){Fe!==De&&(n.clearDepth(De),Fe=De)},reset:function(){U=!1,pe=null,Me=null,Fe=null}}}function a(){let U=!1,pe=null,Me=null,Fe=null,De=null,Ze=null,Je=null,ct=null,ht=null;return{setTest:function(Qe){U||(Qe?Oe(n.STENCIL_TEST):me(n.STENCIL_TEST))},setMask:function(Qe){pe!==Qe&&!U&&(n.stencilMask(Qe),pe=Qe)},setFunc:function(Qe,pt,yn){(Me!==Qe||Fe!==pt||De!==yn)&&(n.stencilFunc(Qe,pt,yn),Me=Qe,Fe=pt,De=yn)},setOp:function(Qe,pt,yn){(Ze!==Qe||Je!==pt||ct!==yn)&&(n.stencilOp(Qe,pt,yn),Ze=Qe,Je=pt,ct=yn)},setLocked:function(Qe){U=Qe},setClear:function(Qe){ht!==Qe&&(n.clearStencil(Qe),ht=Qe)},reset:function(){U=!1,pe=null,Me=null,Fe=null,De=null,Ze=null,Je=null,ct=null,ht=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let h={},m={},x=new WeakMap,_=[],p=null,d=!1,y=null,S=null,E=null,D=null,C=null,w=null,$=null,T=new Ye(0,0,0),A=0,Y=!1,te=null,le=null,I=null,V=null,W=null;const O=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,k=0;const ne=n.getParameter(n.VERSION);ne.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(ne)[1]),G=k>=1):ne.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),G=k>=2);let ue=null,ce={};const Q=n.getParameter(n.SCISSOR_BOX),j=n.getParameter(n.VIEWPORT),xe=new yt().fromArray(Q),ye=new yt().fromArray(j);function be(U,pe,Me,Fe){const De=new Uint8Array(4),Ze=n.createTexture();n.bindTexture(U,Ze),n.texParameteri(U,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(U,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Je=0;Je<Me;Je++)i&&(U===n.TEXTURE_3D||U===n.TEXTURE_2D_ARRAY)?n.texImage3D(pe,0,n.RGBA,1,1,Fe,0,n.RGBA,n.UNSIGNED_BYTE,De):n.texImage2D(pe+Je,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,De);return Ze}const Ue={};Ue[n.TEXTURE_2D]=be(n.TEXTURE_2D,n.TEXTURE_2D,1),Ue[n.TEXTURE_CUBE_MAP]=be(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Ue[n.TEXTURE_2D_ARRAY]=be(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Ue[n.TEXTURE_3D]=be(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Oe(n.DEPTH_TEST),l.setFunc(Ks),re(!1),M(Jl),Oe(n.CULL_FACE),H(Sn);function Oe(U){h[U]!==!0&&(n.enable(U),h[U]=!0)}function me(U){h[U]!==!1&&(n.disable(U),h[U]=!1)}function Le(U,pe){return m[U]!==pe?(n.bindFramebuffer(U,pe),m[U]=pe,i&&(U===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=pe),U===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=pe)),!0):!1}function v(U,pe){let Me=_,Fe=!1;if(U)if(Me=x.get(pe),Me===void 0&&(Me=[],x.set(pe,Me)),U.isWebGLMultipleRenderTargets){const De=U.texture;if(Me.length!==De.length||Me[0]!==n.COLOR_ATTACHMENT0){for(let Ze=0,Je=De.length;Ze<Je;Ze++)Me[Ze]=n.COLOR_ATTACHMENT0+Ze;Me.length=De.length,Fe=!0}}else Me[0]!==n.COLOR_ATTACHMENT0&&(Me[0]=n.COLOR_ATTACHMENT0,Fe=!0);else Me[0]!==n.BACK&&(Me[0]=n.BACK,Fe=!0);Fe&&(t.isWebGL2?n.drawBuffers(Me):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(Me))}function L(U){return p!==U?(n.useProgram(U),p=U,!0):!1}const F={[Ti]:n.FUNC_ADD,[um]:n.FUNC_SUBTRACT,[fm]:n.FUNC_REVERSE_SUBTRACT};if(i)F[tc]=n.MIN,F[nc]=n.MAX;else{const U=e.get("EXT_blend_minmax");U!==null&&(F[tc]=U.MIN_EXT,F[nc]=U.MAX_EXT)}const J={[hm]:n.ZERO,[dm]:n.ONE,[pm]:n.SRC_COLOR,[wo]:n.SRC_ALPHA,[Mm]:n.SRC_ALPHA_SATURATE,[vm]:n.DST_COLOR,[gm]:n.DST_ALPHA,[mm]:n.ONE_MINUS_SRC_COLOR,[Ro]:n.ONE_MINUS_SRC_ALPHA,[xm]:n.ONE_MINUS_DST_COLOR,[_m]:n.ONE_MINUS_DST_ALPHA,[Sm]:n.CONSTANT_COLOR,[Em]:n.ONE_MINUS_CONSTANT_COLOR,[ym]:n.CONSTANT_ALPHA,[Tm]:n.ONE_MINUS_CONSTANT_ALPHA};function H(U,pe,Me,Fe,De,Ze,Je,ct,ht,Qe){if(U===Sn){d===!0&&(me(n.BLEND),d=!1);return}if(d===!1&&(Oe(n.BLEND),d=!0),U!==cm){if(U!==y||Qe!==Y){if((S!==Ti||C!==Ti)&&(n.blendEquation(n.FUNC_ADD),S=Ti,C=Ti),Qe)switch(U){case gr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case js:n.blendFunc(n.ONE,n.ONE);break;case Ql:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ec:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case gr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case js:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ql:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ec:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}E=null,D=null,w=null,$=null,T.set(0,0,0),A=0,y=U,Y=Qe}return}De=De||pe,Ze=Ze||Me,Je=Je||Fe,(pe!==S||De!==C)&&(n.blendEquationSeparate(F[pe],F[De]),S=pe,C=De),(Me!==E||Fe!==D||Ze!==w||Je!==$)&&(n.blendFuncSeparate(J[Me],J[Fe],J[Ze],J[Je]),E=Me,D=Fe,w=Ze,$=Je),(ct.equals(T)===!1||ht!==A)&&(n.blendColor(ct.r,ct.g,ct.b,ht),T.copy(ct),A=ht),y=U,Y=!1}function ie(U,pe){U.side===vn?me(n.CULL_FACE):Oe(n.CULL_FACE);let Me=U.side===Wt;pe&&(Me=!Me),re(Me),U.blending===gr&&U.transparent===!1?H(Sn):H(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),l.setFunc(U.depthFunc),l.setTest(U.depthTest),l.setMask(U.depthWrite),o.setMask(U.colorWrite);const Fe=U.stencilWrite;c.setTest(Fe),Fe&&(c.setMask(U.stencilWriteMask),c.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),c.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),P(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?Oe(n.SAMPLE_ALPHA_TO_COVERAGE):me(n.SAMPLE_ALPHA_TO_COVERAGE)}function re(U){te!==U&&(U?n.frontFace(n.CW):n.frontFace(n.CCW),te=U)}function M(U){U!==am?(Oe(n.CULL_FACE),U!==le&&(U===Jl?n.cullFace(n.BACK):U===om?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):me(n.CULL_FACE),le=U}function g(U){U!==I&&(G&&n.lineWidth(U),I=U)}function P(U,pe,Me){U?(Oe(n.POLYGON_OFFSET_FILL),(V!==pe||W!==Me)&&(n.polygonOffset(pe,Me),V=pe,W=Me)):me(n.POLYGON_OFFSET_FILL)}function q(U){U?Oe(n.SCISSOR_TEST):me(n.SCISSOR_TEST)}function B(U){U===void 0&&(U=n.TEXTURE0+O-1),ue!==U&&(n.activeTexture(U),ue=U)}function X(U,pe,Me){Me===void 0&&(ue===null?Me=n.TEXTURE0+O-1:Me=ue);let Fe=ce[Me];Fe===void 0&&(Fe={type:void 0,texture:void 0},ce[Me]=Fe),(Fe.type!==U||Fe.texture!==pe)&&(ue!==Me&&(n.activeTexture(Me),ue=Me),n.bindTexture(U,pe||Ue[U]),Fe.type=U,Fe.texture=pe)}function oe(){const U=ce[ue];U!==void 0&&U.type!==void 0&&(n.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function ae(){try{n.compressedTexImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function he(){try{n.compressedTexImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function _e(){try{n.texSubImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ce(){try{n.texSubImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function se(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ge(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ne(){try{n.texStorage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ie(){try{n.texStorage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function we(){try{n.texImage2D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ge(){try{n.texImage3D.apply(n,arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function R(U){xe.equals(U)===!1&&(n.scissor(U.x,U.y,U.z,U.w),xe.copy(U))}function de(U){ye.equals(U)===!1&&(n.viewport(U.x,U.y,U.z,U.w),ye.copy(U))}function Re(U,pe){let Me=f.get(pe);Me===void 0&&(Me=new WeakMap,f.set(pe,Me));let Fe=Me.get(U);Fe===void 0&&(Fe=n.getUniformBlockIndex(pe,U.name),Me.set(U,Fe))}function Te(U,pe){const Fe=f.get(pe).get(U);u.get(pe)!==Fe&&(n.uniformBlockBinding(pe,Fe,U.__bindingPointIndex),u.set(pe,Fe))}function fe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},ue=null,ce={},m={},x=new WeakMap,_=[],p=null,d=!1,y=null,S=null,E=null,D=null,C=null,w=null,$=null,T=new Ye(0,0,0),A=0,Y=!1,te=null,le=null,I=null,V=null,W=null,xe.set(0,0,n.canvas.width,n.canvas.height),ye.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:Oe,disable:me,bindFramebuffer:Le,drawBuffers:v,useProgram:L,setBlending:H,setMaterial:ie,setFlipSided:re,setCullFace:M,setLineWidth:g,setPolygonOffset:P,setScissorTest:q,activeTexture:B,bindTexture:X,unbindTexture:oe,compressedTexImage2D:ae,compressedTexImage3D:he,texImage2D:we,texImage3D:ge,updateUBOMapping:Re,uniformBlockBinding:Te,texStorage2D:Ne,texStorage3D:Ie,texSubImage2D:_e,texSubImage3D:Ce,compressedTexSubImage2D:se,compressedTexSubImage3D:Ge,scissor:R,viewport:de,reset:fe}}function nM(n,e,t,i,r,s,a){const o=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new WeakMap;let f;const h=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(M,g){return m?new OffscreenCanvas(M,g):$r("canvas")}function _(M,g,P,q){let B=1;if((M.width>q||M.height>q)&&(B=q/Math.max(M.width,M.height)),B<1||g===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const X=g?Oo:Math.floor,oe=X(B*M.width),ae=X(B*M.height);f===void 0&&(f=x(oe,ae));const he=P?x(oe,ae):f;return he.width=oe,he.height=ae,he.getContext("2d").drawImage(M,0,0,oe,ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+oe+"x"+ae+")."),he}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function p(M){return Lc(M.width)&&Lc(M.height)}function d(M){return o?!1:M.wrapS!==rn||M.wrapT!==rn||M.minFilter!==Ft&&M.minFilter!==nn}function y(M,g){return M.generateMipmaps&&g&&M.minFilter!==Ft&&M.minFilter!==nn}function S(M){n.generateMipmap(M)}function E(M,g,P,q,B=!1){if(o===!1)return g;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let X=g;if(g===n.RED&&(P===n.FLOAT&&(X=n.R32F),P===n.HALF_FLOAT&&(X=n.R16F),P===n.UNSIGNED_BYTE&&(X=n.R8)),g===n.RED_INTEGER&&(P===n.UNSIGNED_BYTE&&(X=n.R8UI),P===n.UNSIGNED_SHORT&&(X=n.R16UI),P===n.UNSIGNED_INT&&(X=n.R32UI),P===n.BYTE&&(X=n.R8I),P===n.SHORT&&(X=n.R16I),P===n.INT&&(X=n.R32I)),g===n.RG&&(P===n.FLOAT&&(X=n.RG32F),P===n.HALF_FLOAT&&(X=n.RG16F),P===n.UNSIGNED_BYTE&&(X=n.RG8)),g===n.RGBA){const oe=B?$s:nt.getTransfer(q);P===n.FLOAT&&(X=n.RGBA32F),P===n.HALF_FLOAT&&(X=n.RGBA16F),P===n.UNSIGNED_BYTE&&(X=oe===at?n.SRGB8_ALPHA8:n.RGBA8),P===n.UNSIGNED_SHORT_4_4_4_4&&(X=n.RGBA4),P===n.UNSIGNED_SHORT_5_5_5_1&&(X=n.RGB5_A1)}return(X===n.R16F||X===n.R32F||X===n.RG16F||X===n.RG32F||X===n.RGBA16F||X===n.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function D(M,g,P){return y(M,P)===!0||M.isFramebufferTexture&&M.minFilter!==Ft&&M.minFilter!==nn?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function C(M){return M===Ft||M===ic||M===Oa?n.NEAREST:n.LINEAR}function w(M){const g=M.target;g.removeEventListener("dispose",w),T(g),g.isVideoTexture&&u.delete(g)}function $(M){const g=M.target;g.removeEventListener("dispose",$),Y(g)}function T(M){const g=i.get(M);if(g.__webglInit===void 0)return;const P=M.source,q=h.get(P);if(q){const B=q[g.__cacheKey];B.usedTimes--,B.usedTimes===0&&A(M),Object.keys(q).length===0&&h.delete(P)}i.remove(M)}function A(M){const g=i.get(M);n.deleteTexture(g.__webglTexture);const P=M.source,q=h.get(P);delete q[g.__cacheKey],a.memory.textures--}function Y(M){const g=M.texture,P=i.get(M),q=i.get(g);if(q.__webglTexture!==void 0&&(n.deleteTexture(q.__webglTexture),a.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let B=0;B<6;B++){if(Array.isArray(P.__webglFramebuffer[B]))for(let X=0;X<P.__webglFramebuffer[B].length;X++)n.deleteFramebuffer(P.__webglFramebuffer[B][X]);else n.deleteFramebuffer(P.__webglFramebuffer[B]);P.__webglDepthbuffer&&n.deleteRenderbuffer(P.__webglDepthbuffer[B])}else{if(Array.isArray(P.__webglFramebuffer))for(let B=0;B<P.__webglFramebuffer.length;B++)n.deleteFramebuffer(P.__webglFramebuffer[B]);else n.deleteFramebuffer(P.__webglFramebuffer);if(P.__webglDepthbuffer&&n.deleteRenderbuffer(P.__webglDepthbuffer),P.__webglMultisampledFramebuffer&&n.deleteFramebuffer(P.__webglMultisampledFramebuffer),P.__webglColorRenderbuffer)for(let B=0;B<P.__webglColorRenderbuffer.length;B++)P.__webglColorRenderbuffer[B]&&n.deleteRenderbuffer(P.__webglColorRenderbuffer[B]);P.__webglDepthRenderbuffer&&n.deleteRenderbuffer(P.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let B=0,X=g.length;B<X;B++){const oe=i.get(g[B]);oe.__webglTexture&&(n.deleteTexture(oe.__webglTexture),a.memory.textures--),i.remove(g[B])}i.remove(g),i.remove(M)}let te=0;function le(){te=0}function I(){const M=te;return M>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),te+=1,M}function V(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function W(M,g){const P=i.get(M);if(M.isVideoTexture&&ie(M),M.isRenderTargetTexture===!1&&M.version>0&&P.__version!==M.version){const q=M.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{xe(P,M,g);return}}t.bindTexture(n.TEXTURE_2D,P.__webglTexture,n.TEXTURE0+g)}function O(M,g){const P=i.get(M);if(M.version>0&&P.__version!==M.version){xe(P,M,g);return}t.bindTexture(n.TEXTURE_2D_ARRAY,P.__webglTexture,n.TEXTURE0+g)}function G(M,g){const P=i.get(M);if(M.version>0&&P.__version!==M.version){xe(P,M,g);return}t.bindTexture(n.TEXTURE_3D,P.__webglTexture,n.TEXTURE0+g)}function k(M,g){const P=i.get(M);if(M.version>0&&P.__version!==M.version){ye(P,M,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+g)}const ne={[Lo]:n.REPEAT,[rn]:n.CLAMP_TO_EDGE,[Do]:n.MIRRORED_REPEAT},ue={[Ft]:n.NEAREST,[ic]:n.NEAREST_MIPMAP_NEAREST,[Oa]:n.NEAREST_MIPMAP_LINEAR,[nn]:n.LINEAR,[Hm]:n.LINEAR_MIPMAP_NEAREST,[Sr]:n.LINEAR_MIPMAP_LINEAR},ce={[Zm]:n.NEVER,[ig]:n.ALWAYS,[Jm]:n.LESS,[ih]:n.LEQUAL,[Qm]:n.EQUAL,[ng]:n.GEQUAL,[eg]:n.GREATER,[tg]:n.NOTEQUAL};function Q(M,g,P){if(P?(n.texParameteri(M,n.TEXTURE_WRAP_S,ne[g.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,ne[g.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,ne[g.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,ue[g.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,ue[g.minFilter])):(n.texParameteri(M,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(M,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(g.wrapS!==rn||g.wrapT!==rn)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,n.TEXTURE_MAG_FILTER,C(g.magFilter)),n.texParameteri(M,n.TEXTURE_MIN_FILTER,C(g.minFilter)),g.minFilter!==Ft&&g.minFilter!==nn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),g.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,ce[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const q=e.get("EXT_texture_filter_anisotropic");if(g.magFilter===Ft||g.minFilter!==Oa&&g.minFilter!==Sr||g.type===ai&&e.has("OES_texture_float_linear")===!1||o===!1&&g.type===cn&&e.has("OES_texture_half_float_linear")===!1)return;(g.anisotropy>1||i.get(g).__currentAnisotropy)&&(n.texParameterf(M,q.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy)}}function j(M,g){let P=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",w));const q=g.source;let B=h.get(q);B===void 0&&(B={},h.set(q,B));const X=V(g);if(X!==M.__cacheKey){B[X]===void 0&&(B[X]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,P=!0),B[X].usedTimes++;const oe=B[M.__cacheKey];oe!==void 0&&(B[M.__cacheKey].usedTimes--,oe.usedTimes===0&&A(g)),M.__cacheKey=X,M.__webglTexture=B[X].texture}return P}function xe(M,g,P){let q=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(q=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(q=n.TEXTURE_3D);const B=j(M,g),X=g.source;t.bindTexture(q,M.__webglTexture,n.TEXTURE0+P);const oe=i.get(X);if(X.version!==oe.__version||B===!0){t.activeTexture(n.TEXTURE0+P);const ae=nt.getPrimaries(nt.workingColorSpace),he=g.colorSpace===hn?null:nt.getPrimaries(g.colorSpace),_e=g.colorSpace===hn||ae===he?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,_e);const Ce=d(g)&&p(g.image)===!1;let se=_(g.image,Ce,!1,r.maxTextureSize);se=re(g,se);const Ge=p(se)||o,Ne=s.convert(g.format,g.colorSpace);let Ie=s.convert(g.type),we=E(g.internalFormat,Ne,Ie,g.colorSpace,g.isVideoTexture);Q(q,g,Ge);let ge;const R=g.mipmaps,de=o&&g.isVideoTexture!==!0&&we!==Qf,Re=oe.__version===void 0||B===!0,Te=D(g,se,Ge);if(g.isDepthTexture)we=n.DEPTH_COMPONENT,o?g.type===ai?we=n.DEPTH_COMPONENT32F:g.type===si?we=n.DEPTH_COMPONENT24:g.type===wi?we=n.DEPTH24_STENCIL8:we=n.DEPTH_COMPONENT16:g.type===ai&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),g.format===Ri&&we===n.DEPTH_COMPONENT&&g.type!==ol&&g.type!==si&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),g.type=si,Ie=s.convert(g.type)),g.format===Er&&we===n.DEPTH_COMPONENT&&(we=n.DEPTH_STENCIL,g.type!==wi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),g.type=wi,Ie=s.convert(g.type))),Re&&(de?t.texStorage2D(n.TEXTURE_2D,1,we,se.width,se.height):t.texImage2D(n.TEXTURE_2D,0,we,se.width,se.height,0,Ne,Ie,null));else if(g.isDataTexture)if(R.length>0&&Ge){de&&Re&&t.texStorage2D(n.TEXTURE_2D,Te,we,R[0].width,R[0].height);for(let fe=0,U=R.length;fe<U;fe++)ge=R[fe],de?t.texSubImage2D(n.TEXTURE_2D,fe,0,0,ge.width,ge.height,Ne,Ie,ge.data):t.texImage2D(n.TEXTURE_2D,fe,we,ge.width,ge.height,0,Ne,Ie,ge.data);g.generateMipmaps=!1}else de?(Re&&t.texStorage2D(n.TEXTURE_2D,Te,we,se.width,se.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,se.width,se.height,Ne,Ie,se.data)):t.texImage2D(n.TEXTURE_2D,0,we,se.width,se.height,0,Ne,Ie,se.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){de&&Re&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Te,we,R[0].width,R[0].height,se.depth);for(let fe=0,U=R.length;fe<U;fe++)ge=R[fe],g.format!==xn?Ne!==null?de?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,fe,0,0,0,ge.width,ge.height,se.depth,Ne,ge.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,fe,we,ge.width,ge.height,se.depth,0,ge.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):de?t.texSubImage3D(n.TEXTURE_2D_ARRAY,fe,0,0,0,ge.width,ge.height,se.depth,Ne,Ie,ge.data):t.texImage3D(n.TEXTURE_2D_ARRAY,fe,we,ge.width,ge.height,se.depth,0,Ne,Ie,ge.data)}else{de&&Re&&t.texStorage2D(n.TEXTURE_2D,Te,we,R[0].width,R[0].height);for(let fe=0,U=R.length;fe<U;fe++)ge=R[fe],g.format!==xn?Ne!==null?de?t.compressedTexSubImage2D(n.TEXTURE_2D,fe,0,0,ge.width,ge.height,Ne,ge.data):t.compressedTexImage2D(n.TEXTURE_2D,fe,we,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):de?t.texSubImage2D(n.TEXTURE_2D,fe,0,0,ge.width,ge.height,Ne,Ie,ge.data):t.texImage2D(n.TEXTURE_2D,fe,we,ge.width,ge.height,0,Ne,Ie,ge.data)}else if(g.isDataArrayTexture)de?(Re&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Te,we,se.width,se.height,se.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,Ne,Ie,se.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,we,se.width,se.height,se.depth,0,Ne,Ie,se.data);else if(g.isData3DTexture)de?(Re&&t.texStorage3D(n.TEXTURE_3D,Te,we,se.width,se.height,se.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,Ne,Ie,se.data)):t.texImage3D(n.TEXTURE_3D,0,we,se.width,se.height,se.depth,0,Ne,Ie,se.data);else if(g.isFramebufferTexture){if(Re)if(de)t.texStorage2D(n.TEXTURE_2D,Te,we,se.width,se.height);else{let fe=se.width,U=se.height;for(let pe=0;pe<Te;pe++)t.texImage2D(n.TEXTURE_2D,pe,we,fe,U,0,Ne,Ie,null),fe>>=1,U>>=1}}else if(R.length>0&&Ge){de&&Re&&t.texStorage2D(n.TEXTURE_2D,Te,we,R[0].width,R[0].height);for(let fe=0,U=R.length;fe<U;fe++)ge=R[fe],de?t.texSubImage2D(n.TEXTURE_2D,fe,0,0,Ne,Ie,ge):t.texImage2D(n.TEXTURE_2D,fe,we,Ne,Ie,ge);g.generateMipmaps=!1}else de?(Re&&t.texStorage2D(n.TEXTURE_2D,Te,we,se.width,se.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ne,Ie,se)):t.texImage2D(n.TEXTURE_2D,0,we,Ne,Ie,se);y(g,Ge)&&S(q),oe.__version=X.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function ye(M,g,P){if(g.image.length!==6)return;const q=j(M,g),B=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+P);const X=i.get(B);if(B.version!==X.__version||q===!0){t.activeTexture(n.TEXTURE0+P);const oe=nt.getPrimaries(nt.workingColorSpace),ae=g.colorSpace===hn?null:nt.getPrimaries(g.colorSpace),he=g.colorSpace===hn||oe===ae?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,he);const _e=g.isCompressedTexture||g.image[0].isCompressedTexture,Ce=g.image[0]&&g.image[0].isDataTexture,se=[];for(let fe=0;fe<6;fe++)!_e&&!Ce?se[fe]=_(g.image[fe],!1,!0,r.maxCubemapSize):se[fe]=Ce?g.image[fe].image:g.image[fe],se[fe]=re(g,se[fe]);const Ge=se[0],Ne=p(Ge)||o,Ie=s.convert(g.format,g.colorSpace),we=s.convert(g.type),ge=E(g.internalFormat,Ie,we,g.colorSpace),R=o&&g.isVideoTexture!==!0,de=X.__version===void 0||q===!0;let Re=D(g,Ge,Ne);Q(n.TEXTURE_CUBE_MAP,g,Ne);let Te;if(_e){R&&de&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,ge,Ge.width,Ge.height);for(let fe=0;fe<6;fe++){Te=se[fe].mipmaps;for(let U=0;U<Te.length;U++){const pe=Te[U];g.format!==xn?Ie!==null?R?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U,0,0,pe.width,pe.height,Ie,pe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U,ge,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):R?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U,0,0,pe.width,pe.height,Ie,we,pe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U,ge,pe.width,pe.height,0,Ie,we,pe.data)}}}else{Te=g.mipmaps,R&&de&&(Te.length>0&&Re++,t.texStorage2D(n.TEXTURE_CUBE_MAP,Re,ge,se[0].width,se[0].height));for(let fe=0;fe<6;fe++)if(Ce){R?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,se[fe].width,se[fe].height,Ie,we,se[fe].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,ge,se[fe].width,se[fe].height,0,Ie,we,se[fe].data);for(let U=0;U<Te.length;U++){const Me=Te[U].image[fe].image;R?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U+1,0,0,Me.width,Me.height,Ie,we,Me.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U+1,ge,Me.width,Me.height,0,Ie,we,Me.data)}}else{R?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,Ie,we,se[fe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,ge,Ie,we,se[fe]);for(let U=0;U<Te.length;U++){const pe=Te[U];R?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U+1,0,0,Ie,we,pe.image[fe]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+fe,U+1,ge,Ie,we,pe.image[fe])}}}y(g,Ne)&&S(n.TEXTURE_CUBE_MAP),X.__version=B.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function be(M,g,P,q,B,X){const oe=s.convert(P.format,P.colorSpace),ae=s.convert(P.type),he=E(P.internalFormat,oe,ae,P.colorSpace);if(!i.get(g).__hasExternalTextures){const Ce=Math.max(1,g.width>>X),se=Math.max(1,g.height>>X);B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?t.texImage3D(B,X,he,Ce,se,g.depth,0,oe,ae,null):t.texImage2D(B,X,he,Ce,se,0,oe,ae,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),H(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,q,B,i.get(P).__webglTexture,0,J(g)):(B===n.TEXTURE_2D||B>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&B<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,q,B,i.get(P).__webglTexture,X),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ue(M,g,P){if(n.bindRenderbuffer(n.RENDERBUFFER,M),g.depthBuffer&&!g.stencilBuffer){let q=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(P||H(g)){const B=g.depthTexture;B&&B.isDepthTexture&&(B.type===ai?q=n.DEPTH_COMPONENT32F:B.type===si&&(q=n.DEPTH_COMPONENT24));const X=J(g);H(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,X,q,g.width,g.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,X,q,g.width,g.height)}else n.renderbufferStorage(n.RENDERBUFFER,q,g.width,g.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,M)}else if(g.depthBuffer&&g.stencilBuffer){const q=J(g);P&&H(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,q,n.DEPTH24_STENCIL8,g.width,g.height):H(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,q,n.DEPTH24_STENCIL8,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,M)}else{const q=g.isWebGLMultipleRenderTargets===!0?g.texture:[g.texture];for(let B=0;B<q.length;B++){const X=q[B],oe=s.convert(X.format,X.colorSpace),ae=s.convert(X.type),he=E(X.internalFormat,oe,ae,X.colorSpace),_e=J(g);P&&H(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,_e,he,g.width,g.height):H(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,_e,he,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,he,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Oe(M,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),W(g.depthTexture,0);const q=i.get(g.depthTexture).__webglTexture,B=J(g);if(g.depthTexture.format===Ri)H(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,q,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,q,0);else if(g.depthTexture.format===Er)H(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,q,0,B):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,q,0);else throw new Error("Unknown depthTexture format")}function me(M){const g=i.get(M),P=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!g.__autoAllocateDepthBuffer){if(P)throw new Error("target.depthTexture not supported in Cube render targets");Oe(g.__webglFramebuffer,M)}else if(P){g.__webglDepthbuffer=[];for(let q=0;q<6;q++)t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[q]),g.__webglDepthbuffer[q]=n.createRenderbuffer(),Ue(g.__webglDepthbuffer[q],M,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=n.createRenderbuffer(),Ue(g.__webglDepthbuffer,M,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function Le(M,g,P){const q=i.get(M);g!==void 0&&be(q.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),P!==void 0&&me(M)}function v(M){const g=M.texture,P=i.get(M),q=i.get(g);M.addEventListener("dispose",$),M.isWebGLMultipleRenderTargets!==!0&&(q.__webglTexture===void 0&&(q.__webglTexture=n.createTexture()),q.__version=g.version,a.memory.textures++);const B=M.isWebGLCubeRenderTarget===!0,X=M.isWebGLMultipleRenderTargets===!0,oe=p(M)||o;if(B){P.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(o&&g.mipmaps&&g.mipmaps.length>0){P.__webglFramebuffer[ae]=[];for(let he=0;he<g.mipmaps.length;he++)P.__webglFramebuffer[ae][he]=n.createFramebuffer()}else P.__webglFramebuffer[ae]=n.createFramebuffer()}else{if(o&&g.mipmaps&&g.mipmaps.length>0){P.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)P.__webglFramebuffer[ae]=n.createFramebuffer()}else P.__webglFramebuffer=n.createFramebuffer();if(X)if(r.drawBuffers){const ae=M.texture;for(let he=0,_e=ae.length;he<_e;he++){const Ce=i.get(ae[he]);Ce.__webglTexture===void 0&&(Ce.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&M.samples>0&&H(M)===!1){const ae=X?g:[g];P.__webglMultisampledFramebuffer=n.createFramebuffer(),P.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,P.__webglMultisampledFramebuffer);for(let he=0;he<ae.length;he++){const _e=ae[he];P.__webglColorRenderbuffer[he]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,P.__webglColorRenderbuffer[he]);const Ce=s.convert(_e.format,_e.colorSpace),se=s.convert(_e.type),Ge=E(_e.internalFormat,Ce,se,_e.colorSpace,M.isXRRenderTarget===!0),Ne=J(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ne,Ge,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+he,n.RENDERBUFFER,P.__webglColorRenderbuffer[he])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(P.__webglDepthRenderbuffer=n.createRenderbuffer(),Ue(P.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(B){t.bindTexture(n.TEXTURE_CUBE_MAP,q.__webglTexture),Q(n.TEXTURE_CUBE_MAP,g,oe);for(let ae=0;ae<6;ae++)if(o&&g.mipmaps&&g.mipmaps.length>0)for(let he=0;he<g.mipmaps.length;he++)be(P.__webglFramebuffer[ae][he],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,he);else be(P.__webglFramebuffer[ae],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);y(g,oe)&&S(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(X){const ae=M.texture;for(let he=0,_e=ae.length;he<_e;he++){const Ce=ae[he],se=i.get(Ce);t.bindTexture(n.TEXTURE_2D,se.__webglTexture),Q(n.TEXTURE_2D,Ce,oe),be(P.__webglFramebuffer,M,Ce,n.COLOR_ATTACHMENT0+he,n.TEXTURE_2D,0),y(Ce,oe)&&S(n.TEXTURE_2D)}t.unbindTexture()}else{let ae=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(o?ae=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ae,q.__webglTexture),Q(ae,g,oe),o&&g.mipmaps&&g.mipmaps.length>0)for(let he=0;he<g.mipmaps.length;he++)be(P.__webglFramebuffer[he],M,g,n.COLOR_ATTACHMENT0,ae,he);else be(P.__webglFramebuffer,M,g,n.COLOR_ATTACHMENT0,ae,0);y(g,oe)&&S(ae),t.unbindTexture()}M.depthBuffer&&me(M)}function L(M){const g=p(M)||o,P=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let q=0,B=P.length;q<B;q++){const X=P[q];if(y(X,g)){const oe=M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ae=i.get(X).__webglTexture;t.bindTexture(oe,ae),S(oe),t.unbindTexture()}}}function F(M){if(o&&M.samples>0&&H(M)===!1){const g=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],P=M.width,q=M.height;let B=n.COLOR_BUFFER_BIT;const X=[],oe=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=i.get(M),he=M.isWebGLMultipleRenderTargets===!0;if(he)for(let _e=0;_e<g.length;_e++)t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+_e,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+_e,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let _e=0;_e<g.length;_e++){X.push(n.COLOR_ATTACHMENT0+_e),M.depthBuffer&&X.push(oe);const Ce=ae.__ignoreDepthValues!==void 0?ae.__ignoreDepthValues:!1;if(Ce===!1&&(M.depthBuffer&&(B|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&(B|=n.STENCIL_BUFFER_BIT)),he&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ae.__webglColorRenderbuffer[_e]),Ce===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[oe]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[oe])),he){const se=i.get(g[_e]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,se,0)}n.blitFramebuffer(0,0,P,q,0,0,P,q,B,n.NEAREST),c&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,X)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),he)for(let _e=0;_e<g.length;_e++){t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+_e,n.RENDERBUFFER,ae.__webglColorRenderbuffer[_e]);const Ce=i.get(g[_e]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+_e,n.TEXTURE_2D,Ce,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}}function J(M){return Math.min(r.maxSamples,M.samples)}function H(M){const g=i.get(M);return o&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function ie(M){const g=a.render.frame;u.get(M)!==g&&(u.set(M,g),M.update())}function re(M,g){const P=M.colorSpace,q=M.format,B=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===Io||P!==Pn&&P!==hn&&(nt.getTransfer(P)===at?o===!1?e.has("EXT_sRGB")===!0&&q===xn?(M.format=Io,M.minFilter=nn,M.generateMipmaps=!1):g=sh.sRGBToLinear(g):(q!==xn||B!==ci)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",P)),g}this.allocateTextureUnit=I,this.resetTextureUnits=le,this.setTexture2D=W,this.setTexture2DArray=O,this.setTexture3D=G,this.setTextureCube=k,this.rebindTextures=Le,this.setupRenderTarget=v,this.updateRenderTargetMipmap=L,this.updateMultisampleRenderTarget=F,this.setupDepthRenderbuffer=me,this.setupFrameBufferTexture=be,this.useMultisampledRTT=H}function iM(n,e,t){const i=t.isWebGL2;function r(s,a=hn){let o;const l=nt.getTransfer(a);if(s===ci)return n.UNSIGNED_BYTE;if(s===jf)return n.UNSIGNED_SHORT_4_4_4_4;if(s===Kf)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Gm)return n.BYTE;if(s===Vm)return n.SHORT;if(s===ol)return n.UNSIGNED_SHORT;if(s===Yf)return n.INT;if(s===si)return n.UNSIGNED_INT;if(s===ai)return n.FLOAT;if(s===cn)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===km)return n.ALPHA;if(s===xn)return n.RGBA;if(s===Wm)return n.LUMINANCE;if(s===Xm)return n.LUMINANCE_ALPHA;if(s===Ri)return n.DEPTH_COMPONENT;if(s===Er)return n.DEPTH_STENCIL;if(s===Io)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===qm)return n.RED;if(s===$f)return n.RED_INTEGER;if(s===Ym)return n.RG;if(s===Zf)return n.RG_INTEGER;if(s===Jf)return n.RGBA_INTEGER;if(s===Fa||s===Ba||s===za||s===Ha)if(l===at)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Fa)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Ba)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===za)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Ha)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Fa)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Ba)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===za)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Ha)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===rc||s===sc||s===ac||s===oc)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===rc)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===sc)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===ac)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===oc)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Qf)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===lc||s===cc)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===lc)return l===at?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===cc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===uc||s===fc||s===hc||s===dc||s===pc||s===mc||s===gc||s===_c||s===vc||s===xc||s===Mc||s===Sc||s===Ec||s===yc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===uc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===fc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===hc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===dc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===pc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===mc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===gc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===_c)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===vc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===xc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Mc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Sc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Ec)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===yc)return l===at?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Ga||s===Tc||s===bc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===Ga)return l===at?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Tc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===bc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===jm||s===Ac||s===wc||s===Rc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===Ga)return o.COMPRESSED_RED_RGTC1_EXT;if(s===Ac)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===wc)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Rc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===wi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class rM extends fn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Br extends Tt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const sM={type:"move"};class fo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Br,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Br,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new N,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new N),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Br,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new N,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new N),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const _ of e.hand.values()){const p=t.getJointPose(_,i),d=this._getHandJoint(c,_);p!==null&&(d.matrix.fromArray(p.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=p.radius),d.visible=p!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),m=.02,x=.005;c.inputState.pinching&&h>m+x?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=m-x&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(sM)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Br;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class aM extends Di{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,h=null,m=null,x=null;const _=t.getContextAttributes();let p=null,d=null;const y=[],S=[],E=new Ae;let D=null;const C=new fn;C.layers.enable(1),C.viewport=new yt;const w=new fn;w.layers.enable(2),w.viewport=new yt;const $=[C,w],T=new rM;T.layers.enable(1),T.layers.enable(2);let A=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Q){let j=y[Q];return j===void 0&&(j=new fo,y[Q]=j),j.getTargetRaySpace()},this.getControllerGrip=function(Q){let j=y[Q];return j===void 0&&(j=new fo,y[Q]=j),j.getGripSpace()},this.getHand=function(Q){let j=y[Q];return j===void 0&&(j=new fo,y[Q]=j),j.getHandSpace()};function te(Q){const j=S.indexOf(Q.inputSource);if(j===-1)return;const xe=y[j];xe!==void 0&&(xe.update(Q.inputSource,Q.frame,c||a),xe.dispatchEvent({type:Q.type,data:Q.inputSource}))}function le(){r.removeEventListener("select",te),r.removeEventListener("selectstart",te),r.removeEventListener("selectend",te),r.removeEventListener("squeeze",te),r.removeEventListener("squeezestart",te),r.removeEventListener("squeezeend",te),r.removeEventListener("end",le),r.removeEventListener("inputsourceschange",I);for(let Q=0;Q<y.length;Q++){const j=S[Q];j!==null&&(S[Q]=null,y[Q].disconnect(j))}A=null,Y=null,e.setRenderTarget(p),m=null,h=null,f=null,r=null,d=null,ce.stop(),i.isPresenting=!1,e.setPixelRatio(D),e.setSize(E.width,E.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Q){s=Q,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Q){o=Q,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(Q){c=Q},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(Q){if(r=Q,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",te),r.addEventListener("selectstart",te),r.addEventListener("selectend",te),r.addEventListener("squeeze",te),r.addEventListener("squeezestart",te),r.addEventListener("squeezeend",te),r.addEventListener("end",le),r.addEventListener("inputsourceschange",I),_.xrCompatible!==!0&&await t.makeXRCompatible(),D=e.getPixelRatio(),e.getSize(E),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const j={antialias:r.renderState.layers===void 0?_.antialias:!0,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,j),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),d=new Bt(m.framebufferWidth,m.framebufferHeight,{format:xn,type:ci,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil})}else{let j=null,xe=null,ye=null;_.depth&&(ye=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,j=_.stencil?Er:Ri,xe=_.stencil?wi:si);const be={colorFormat:t.RGBA8,depthFormat:ye,scaleFactor:s};f=new XRWebGLBinding(r,t),h=f.createProjectionLayer(be),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),d=new Bt(h.textureWidth,h.textureHeight,{format:xn,type:ci,depthTexture:new mh(h.textureWidth,h.textureHeight,xe,void 0,void 0,void 0,void 0,void 0,void 0,j),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0});const Ue=e.properties.get(d);Ue.__ignoreDepthValues=h.ignoreDepthValues}d.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),ce.setContext(r),ce.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function I(Q){for(let j=0;j<Q.removed.length;j++){const xe=Q.removed[j],ye=S.indexOf(xe);ye>=0&&(S[ye]=null,y[ye].disconnect(xe))}for(let j=0;j<Q.added.length;j++){const xe=Q.added[j];let ye=S.indexOf(xe);if(ye===-1){for(let Ue=0;Ue<y.length;Ue++)if(Ue>=S.length){S.push(xe),ye=Ue;break}else if(S[Ue]===null){S[Ue]=xe,ye=Ue;break}if(ye===-1)break}const be=y[ye];be&&be.connect(xe)}}const V=new N,W=new N;function O(Q,j,xe){V.setFromMatrixPosition(j.matrixWorld),W.setFromMatrixPosition(xe.matrixWorld);const ye=V.distanceTo(W),be=j.projectionMatrix.elements,Ue=xe.projectionMatrix.elements,Oe=be[14]/(be[10]-1),me=be[14]/(be[10]+1),Le=(be[9]+1)/be[5],v=(be[9]-1)/be[5],L=(be[8]-1)/be[0],F=(Ue[8]+1)/Ue[0],J=Oe*L,H=Oe*F,ie=ye/(-L+F),re=ie*-L;j.matrixWorld.decompose(Q.position,Q.quaternion,Q.scale),Q.translateX(re),Q.translateZ(ie),Q.matrixWorld.compose(Q.position,Q.quaternion,Q.scale),Q.matrixWorldInverse.copy(Q.matrixWorld).invert();const M=Oe+ie,g=me+ie,P=J-re,q=H+(ye-re),B=Le*me/g*M,X=v*me/g*M;Q.projectionMatrix.makePerspective(P,q,B,X,M,g),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert()}function G(Q,j){j===null?Q.matrixWorld.copy(Q.matrix):Q.matrixWorld.multiplyMatrices(j.matrixWorld,Q.matrix),Q.matrixWorldInverse.copy(Q.matrixWorld).invert()}this.updateCamera=function(Q){if(r===null)return;T.near=w.near=C.near=Q.near,T.far=w.far=C.far=Q.far,(A!==T.near||Y!==T.far)&&(r.updateRenderState({depthNear:T.near,depthFar:T.far}),A=T.near,Y=T.far);const j=Q.parent,xe=T.cameras;G(T,j);for(let ye=0;ye<xe.length;ye++)G(xe[ye],j);xe.length===2?O(T,C,w):T.projectionMatrix.copy(C.projectionMatrix),k(Q,T,j)};function k(Q,j,xe){xe===null?Q.matrix.copy(j.matrixWorld):(Q.matrix.copy(xe.matrixWorld),Q.matrix.invert(),Q.matrix.multiply(j.matrixWorld)),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.updateMatrixWorld(!0),Q.projectionMatrix.copy(j.projectionMatrix),Q.projectionMatrixInverse.copy(j.projectionMatrixInverse),Q.isPerspectiveCamera&&(Q.fov=No*2*Math.atan(1/Q.projectionMatrix.elements[5]),Q.zoom=1)}this.getCamera=function(){return T},this.getFoveation=function(){if(!(h===null&&m===null))return l},this.setFoveation=function(Q){l=Q,h!==null&&(h.fixedFoveation=Q),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Q)};let ne=null;function ue(Q,j){if(u=j.getViewerPose(c||a),x=j,u!==null){const xe=u.views;m!==null&&(e.setRenderTargetFramebuffer(d,m.framebuffer),e.setRenderTarget(d));let ye=!1;xe.length!==T.cameras.length&&(T.cameras.length=0,ye=!0);for(let be=0;be<xe.length;be++){const Ue=xe[be];let Oe=null;if(m!==null)Oe=m.getViewport(Ue);else{const Le=f.getViewSubImage(h,Ue);Oe=Le.viewport,be===0&&(e.setRenderTargetTextures(d,Le.colorTexture,h.ignoreDepthValues?void 0:Le.depthStencilTexture),e.setRenderTarget(d))}let me=$[be];me===void 0&&(me=new fn,me.layers.enable(be),me.viewport=new yt,$[be]=me),me.matrix.fromArray(Ue.transform.matrix),me.matrix.decompose(me.position,me.quaternion,me.scale),me.projectionMatrix.fromArray(Ue.projectionMatrix),me.projectionMatrixInverse.copy(me.projectionMatrix).invert(),me.viewport.set(Oe.x,Oe.y,Oe.width,Oe.height),be===0&&(T.matrix.copy(me.matrix),T.matrix.decompose(T.position,T.quaternion,T.scale)),ye===!0&&T.cameras.push(me)}}for(let xe=0;xe<y.length;xe++){const ye=S[xe],be=y[xe];ye!==null&&be!==void 0&&be.update(ye,j,c||a)}ne&&ne(Q,j),j.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:j}),x=null}const ce=new ph;ce.setAnimationLoop(ue),this.setAnimationLoop=function(Q){ne=Q},this.dispose=function(){}}}function oM(n,e){function t(p,d){p.matrixAutoUpdate===!0&&p.updateMatrix(),d.value.copy(p.matrix)}function i(p,d){d.color.getRGB(p.fogColor.value,fh(n)),d.isFog?(p.fogNear.value=d.near,p.fogFar.value=d.far):d.isFogExp2&&(p.fogDensity.value=d.density)}function r(p,d,y,S,E){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(p,d):d.isMeshToonMaterial?(s(p,d),f(p,d)):d.isMeshPhongMaterial?(s(p,d),u(p,d)):d.isMeshStandardMaterial?(s(p,d),h(p,d),d.isMeshPhysicalMaterial&&m(p,d,E)):d.isMeshMatcapMaterial?(s(p,d),x(p,d)):d.isMeshDepthMaterial?s(p,d):d.isMeshDistanceMaterial?(s(p,d),_(p,d)):d.isMeshNormalMaterial?s(p,d):d.isLineBasicMaterial?(a(p,d),d.isLineDashedMaterial&&o(p,d)):d.isPointsMaterial?l(p,d,y,S):d.isSpriteMaterial?c(p,d):d.isShadowMaterial?(p.color.value.copy(d.color),p.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(p,d){p.opacity.value=d.opacity,d.color&&p.diffuse.value.copy(d.color),d.emissive&&p.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.bumpMap&&(p.bumpMap.value=d.bumpMap,t(d.bumpMap,p.bumpMapTransform),p.bumpScale.value=d.bumpScale,d.side===Wt&&(p.bumpScale.value*=-1)),d.normalMap&&(p.normalMap.value=d.normalMap,t(d.normalMap,p.normalMapTransform),p.normalScale.value.copy(d.normalScale),d.side===Wt&&p.normalScale.value.negate()),d.displacementMap&&(p.displacementMap.value=d.displacementMap,t(d.displacementMap,p.displacementMapTransform),p.displacementScale.value=d.displacementScale,p.displacementBias.value=d.displacementBias),d.emissiveMap&&(p.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,p.emissiveMapTransform)),d.specularMap&&(p.specularMap.value=d.specularMap,t(d.specularMap,p.specularMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);const y=e.get(d).envMap;if(y&&(p.envMap.value=y,p.flipEnvMap.value=y.isCubeTexture&&y.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=d.reflectivity,p.ior.value=d.ior,p.refractionRatio.value=d.refractionRatio),d.lightMap){p.lightMap.value=d.lightMap;const S=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=d.lightMapIntensity*S,t(d.lightMap,p.lightMapTransform)}d.aoMap&&(p.aoMap.value=d.aoMap,p.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,p.aoMapTransform))}function a(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform))}function o(p,d){p.dashSize.value=d.dashSize,p.totalSize.value=d.dashSize+d.gapSize,p.scale.value=d.scale}function l(p,d,y,S){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.size.value=d.size*y,p.scale.value=S*.5,d.map&&(p.map.value=d.map,t(d.map,p.uvTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function c(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.rotation.value=d.rotation,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function u(p,d){p.specular.value.copy(d.specular),p.shininess.value=Math.max(d.shininess,1e-4)}function f(p,d){d.gradientMap&&(p.gradientMap.value=d.gradientMap)}function h(p,d){p.metalness.value=d.metalness,d.metalnessMap&&(p.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,p.metalnessMapTransform)),p.roughness.value=d.roughness,d.roughnessMap&&(p.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,p.roughnessMapTransform)),e.get(d).envMap&&(p.envMapIntensity.value=d.envMapIntensity)}function m(p,d,y){p.ior.value=d.ior,d.sheen>0&&(p.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),p.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(p.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,p.sheenColorMapTransform)),d.sheenRoughnessMap&&(p.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,p.sheenRoughnessMapTransform))),d.clearcoat>0&&(p.clearcoat.value=d.clearcoat,p.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(p.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,p.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(p.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Wt&&p.clearcoatNormalScale.value.negate())),d.iridescence>0&&(p.iridescence.value=d.iridescence,p.iridescenceIOR.value=d.iridescenceIOR,p.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(p.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,p.iridescenceMapTransform)),d.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),d.transmission>0&&(p.transmission.value=d.transmission,p.transmissionSamplerMap.value=y.texture,p.transmissionSamplerSize.value.set(y.width,y.height),d.transmissionMap&&(p.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,p.transmissionMapTransform)),p.thickness.value=d.thickness,d.thicknessMap&&(p.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=d.attenuationDistance,p.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(p.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(p.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=d.specularIntensity,p.specularColor.value.copy(d.specularColor),d.specularColorMap&&(p.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,p.specularColorMapTransform)),d.specularIntensityMap&&(p.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,d){d.matcap&&(p.matcap.value=d.matcap)}function _(p,d){const y=e.get(d).light;p.referencePosition.value.setFromMatrixPosition(y.matrixWorld),p.nearDistance.value=y.shadow.camera.near,p.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function lM(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(y,S){const E=S.program;i.uniformBlockBinding(y,E)}function c(y,S){let E=r[y.id];E===void 0&&(x(y),E=u(y),r[y.id]=E,y.addEventListener("dispose",p));const D=S.program;i.updateUBOMapping(y,D);const C=e.render.frame;s[y.id]!==C&&(h(y),s[y.id]=C)}function u(y){const S=f();y.__bindingPointIndex=S;const E=n.createBuffer(),D=y.__size,C=y.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,D,C),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,S,E),E}function f(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(y){const S=r[y.id],E=y.uniforms,D=y.__cache;n.bindBuffer(n.UNIFORM_BUFFER,S);for(let C=0,w=E.length;C<w;C++){const $=Array.isArray(E[C])?E[C]:[E[C]];for(let T=0,A=$.length;T<A;T++){const Y=$[T];if(m(Y,C,T,D)===!0){const te=Y.__offset,le=Array.isArray(Y.value)?Y.value:[Y.value];let I=0;for(let V=0;V<le.length;V++){const W=le[V],O=_(W);typeof W=="number"||typeof W=="boolean"?(Y.__data[0]=W,n.bufferSubData(n.UNIFORM_BUFFER,te+I,Y.__data)):W.isMatrix3?(Y.__data[0]=W.elements[0],Y.__data[1]=W.elements[1],Y.__data[2]=W.elements[2],Y.__data[3]=0,Y.__data[4]=W.elements[3],Y.__data[5]=W.elements[4],Y.__data[6]=W.elements[5],Y.__data[7]=0,Y.__data[8]=W.elements[6],Y.__data[9]=W.elements[7],Y.__data[10]=W.elements[8],Y.__data[11]=0):(W.toArray(Y.__data,I),I+=O.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,te,Y.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(y,S,E,D){const C=y.value,w=S+"_"+E;if(D[w]===void 0)return typeof C=="number"||typeof C=="boolean"?D[w]=C:D[w]=C.clone(),!0;{const $=D[w];if(typeof C=="number"||typeof C=="boolean"){if($!==C)return D[w]=C,!0}else if($.equals(C)===!1)return $.copy(C),!0}return!1}function x(y){const S=y.uniforms;let E=0;const D=16;for(let w=0,$=S.length;w<$;w++){const T=Array.isArray(S[w])?S[w]:[S[w]];for(let A=0,Y=T.length;A<Y;A++){const te=T[A],le=Array.isArray(te.value)?te.value:[te.value];for(let I=0,V=le.length;I<V;I++){const W=le[I],O=_(W),G=E%D;G!==0&&D-G<O.boundary&&(E+=D-G),te.__data=new Float32Array(O.storage/Float32Array.BYTES_PER_ELEMENT),te.__offset=E,E+=O.storage}}}const C=E%D;return C>0&&(E+=D-C),y.__size=E,y.__cache={},this}function _(y){const S={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(S.boundary=4,S.storage=4):y.isVector2?(S.boundary=8,S.storage=8):y.isVector3||y.isColor?(S.boundary=16,S.storage=12):y.isVector4?(S.boundary=16,S.storage=16):y.isMatrix3?(S.boundary=48,S.storage=48):y.isMatrix4?(S.boundary=64,S.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),S}function p(y){const S=y.target;S.removeEventListener("dispose",p);const E=a.indexOf(S.__bindingPointIndex);a.splice(E,1),n.deleteBuffer(r[S.id]),delete r[S.id],delete s[S.id]}function d(){for(const y in r)n.deleteBuffer(r[y]);a=[],r={},s={}}return{bind:l,update:c,dispose:d}}class Eh{constructor(e={}){const{canvas:t=ag(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let h;i!==null?h=i.getContextAttributes().alpha:h=a;const m=new Uint32Array(4),x=new Int32Array(4);let _=null,p=null;const d=[],y=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=wt,this._useLegacyLights=!1,this.toneMapping=kn,this.toneMappingExposure=1;const S=this;let E=!1,D=0,C=0,w=null,$=-1,T=null;const A=new yt,Y=new yt;let te=null;const le=new Ye(0);let I=0,V=t.width,W=t.height,O=1,G=null,k=null;const ne=new yt(0,0,V,W),ue=new yt(0,0,V,W);let ce=!1;const Q=new fl;let j=!1,xe=!1,ye=null;const be=new ft,Ue=new Ae,Oe=new N,me={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Le(){return w===null?O:1}let v=i;function L(b,z){for(let Z=0;Z<b.length;Z++){const ee=b[Z],K=t.getContext(ee,z);if(K!==null)return K}return null}try{const b={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${al}`),t.addEventListener("webglcontextlost",fe,!1),t.addEventListener("webglcontextrestored",U,!1),t.addEventListener("webglcontextcreationerror",pe,!1),v===null){const z=["webgl2","webgl","experimental-webgl"];if(S.isWebGL1Renderer===!0&&z.shift(),v=L(z,b),v===null)throw L(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&v instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),v.getShaderPrecisionFormat===void 0&&(v.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let F,J,H,ie,re,M,g,P,q,B,X,oe,ae,he,_e,Ce,se,Ge,Ne,Ie,we,ge,R,de;function Re(){F=new x0(v),J=new d0(v,F,e),F.init(J),ge=new iM(v,F,J),H=new tM(v,F,J),ie=new E0(v),re=new Vx,M=new nM(v,F,H,re,J,ge,ie),g=new m0(S),P=new v0(S),q=new Pg(v,J),R=new f0(v,F,q,J),B=new M0(v,q,ie,R),X=new A0(v,B,q,ie),Ne=new b0(v,J,M),Ce=new p0(re),oe=new Gx(S,g,P,F,J,R,Ce),ae=new oM(S,re),he=new Wx,_e=new $x(F,J),Ge=new u0(S,g,P,H,X,h,l),se=new eM(S,X,J),de=new lM(v,ie,J,H),Ie=new h0(v,F,ie,J),we=new S0(v,F,ie,J),ie.programs=oe.programs,S.capabilities=J,S.extensions=F,S.properties=re,S.renderLists=he,S.shadowMap=se,S.state=H,S.info=ie}Re();const Te=new aM(S,v);this.xr=Te,this.getContext=function(){return v},this.getContextAttributes=function(){return v.getContextAttributes()},this.forceContextLoss=function(){const b=F.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=F.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return O},this.setPixelRatio=function(b){b!==void 0&&(O=b,this.setSize(V,W,!1))},this.getSize=function(b){return b.set(V,W)},this.setSize=function(b,z,Z=!0){if(Te.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}V=b,W=z,t.width=Math.floor(b*O),t.height=Math.floor(z*O),Z===!0&&(t.style.width=b+"px",t.style.height=z+"px"),this.setViewport(0,0,b,z)},this.getDrawingBufferSize=function(b){return b.set(V*O,W*O).floor()},this.setDrawingBufferSize=function(b,z,Z){V=b,W=z,O=Z,t.width=Math.floor(b*Z),t.height=Math.floor(z*Z),this.setViewport(0,0,b,z)},this.getCurrentViewport=function(b){return b.copy(A)},this.getViewport=function(b){return b.copy(ne)},this.setViewport=function(b,z,Z,ee){b.isVector4?ne.set(b.x,b.y,b.z,b.w):ne.set(b,z,Z,ee),H.viewport(A.copy(ne).multiplyScalar(O).floor())},this.getScissor=function(b){return b.copy(ue)},this.setScissor=function(b,z,Z,ee){b.isVector4?ue.set(b.x,b.y,b.z,b.w):ue.set(b,z,Z,ee),H.scissor(Y.copy(ue).multiplyScalar(O).floor())},this.getScissorTest=function(){return ce},this.setScissorTest=function(b){H.setScissorTest(ce=b)},this.setOpaqueSort=function(b){G=b},this.setTransparentSort=function(b){k=b},this.getClearColor=function(b){return b.copy(Ge.getClearColor())},this.setClearColor=function(){Ge.setClearColor.apply(Ge,arguments)},this.getClearAlpha=function(){return Ge.getClearAlpha()},this.setClearAlpha=function(){Ge.setClearAlpha.apply(Ge,arguments)},this.clear=function(b=!0,z=!0,Z=!0){let ee=0;if(b){let K=!1;if(w!==null){const Se=w.texture.format;K=Se===Jf||Se===Zf||Se===$f}if(K){const Se=w.texture.type,Pe=Se===ci||Se===si||Se===ol||Se===wi||Se===jf||Se===Kf,Be=Ge.getClearColor(),ze=Ge.getClearAlpha(),je=Be.r,Ve=Be.g,ke=Be.b;Pe?(m[0]=je,m[1]=Ve,m[2]=ke,m[3]=ze,v.clearBufferuiv(v.COLOR,0,m)):(x[0]=je,x[1]=Ve,x[2]=ke,x[3]=ze,v.clearBufferiv(v.COLOR,0,x))}else ee|=v.COLOR_BUFFER_BIT}z&&(ee|=v.DEPTH_BUFFER_BIT),Z&&(ee|=v.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),v.clear(ee)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",fe,!1),t.removeEventListener("webglcontextrestored",U,!1),t.removeEventListener("webglcontextcreationerror",pe,!1),he.dispose(),_e.dispose(),re.dispose(),g.dispose(),P.dispose(),X.dispose(),R.dispose(),de.dispose(),oe.dispose(),Te.dispose(),Te.removeEventListener("sessionstart",ht),Te.removeEventListener("sessionend",Qe),ye&&(ye.dispose(),ye=null),pt.stop()};function fe(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),E=!0}function U(){console.log("THREE.WebGLRenderer: Context Restored."),E=!1;const b=ie.autoReset,z=se.enabled,Z=se.autoUpdate,ee=se.needsUpdate,K=se.type;Re(),ie.autoReset=b,se.enabled=z,se.autoUpdate=Z,se.needsUpdate=ee,se.type=K}function pe(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function Me(b){const z=b.target;z.removeEventListener("dispose",Me),Fe(z)}function Fe(b){De(b),re.remove(b)}function De(b){const z=re.get(b).programs;z!==void 0&&(z.forEach(function(Z){oe.releaseProgram(Z)}),b.isShaderMaterial&&oe.releaseShaderCache(b))}this.renderBufferDirect=function(b,z,Z,ee,K,Se){z===null&&(z=me);const Pe=K.isMesh&&K.matrixWorld.determinant()<0,Be=Ih(b,z,Z,ee,K);H.setMaterial(ee,Pe);let ze=Z.index,je=1;if(ee.wireframe===!0){if(ze=B.getWireframeAttribute(Z),ze===void 0)return;je=2}const Ve=Z.drawRange,ke=Z.attributes.position;let dt=Ve.start*je,Zt=(Ve.start+Ve.count)*je;Se!==null&&(dt=Math.max(dt,Se.start*je),Zt=Math.min(Zt,(Se.start+Se.count)*je)),ze!==null?(dt=Math.max(dt,0),Zt=Math.min(Zt,ze.count)):ke!=null&&(dt=Math.max(dt,0),Zt=Math.min(Zt,ke.count));const Mt=Zt-dt;if(Mt<0||Mt===1/0)return;R.setup(K,ee,Be,Z,ze);let Ln,ot=Ie;if(ze!==null&&(Ln=q.get(ze),ot=we,ot.setIndex(Ln)),K.isMesh)ee.wireframe===!0?(H.setLineWidth(ee.wireframeLinewidth*Le()),ot.setMode(v.LINES)):ot.setMode(v.TRIANGLES);else if(K.isLine){let Ke=ee.linewidth;Ke===void 0&&(Ke=1),H.setLineWidth(Ke*Le()),K.isLineSegments?ot.setMode(v.LINES):K.isLineLoop?ot.setMode(v.LINE_LOOP):ot.setMode(v.LINE_STRIP)}else K.isPoints?ot.setMode(v.POINTS):K.isSprite&&ot.setMode(v.TRIANGLES);if(K.isBatchedMesh)ot.renderMultiDraw(K._multiDrawStarts,K._multiDrawCounts,K._multiDrawCount);else if(K.isInstancedMesh)ot.renderInstances(dt,Mt,K.count);else if(Z.isInstancedBufferGeometry){const Ke=Z._maxInstanceCount!==void 0?Z._maxInstanceCount:1/0,Ma=Math.min(Z.instanceCount,Ke);ot.renderInstances(dt,Mt,Ma)}else ot.render(dt,Mt)};function Ze(b,z,Z){b.transparent===!0&&b.side===vn&&b.forceSinglePass===!1?(b.side=Wt,b.needsUpdate=!0,is(b,z,Z),b.side=di,b.needsUpdate=!0,is(b,z,Z),b.side=vn):is(b,z,Z)}this.compile=function(b,z,Z=null){Z===null&&(Z=b),p=_e.get(Z),p.init(),y.push(p),Z.traverseVisible(function(K){K.isLight&&K.layers.test(z.layers)&&(p.pushLight(K),K.castShadow&&p.pushShadow(K))}),b!==Z&&b.traverseVisible(function(K){K.isLight&&K.layers.test(z.layers)&&(p.pushLight(K),K.castShadow&&p.pushShadow(K))}),p.setupLights(S._useLegacyLights);const ee=new Set;return b.traverse(function(K){const Se=K.material;if(Se)if(Array.isArray(Se))for(let Pe=0;Pe<Se.length;Pe++){const Be=Se[Pe];Ze(Be,Z,K),ee.add(Be)}else Ze(Se,Z,K),ee.add(Se)}),y.pop(),p=null,ee},this.compileAsync=function(b,z,Z=null){const ee=this.compile(b,z,Z);return new Promise(K=>{function Se(){if(ee.forEach(function(Pe){re.get(Pe).currentProgram.isReady()&&ee.delete(Pe)}),ee.size===0){K(b);return}setTimeout(Se,10)}F.get("KHR_parallel_shader_compile")!==null?Se():setTimeout(Se,10)})};let Je=null;function ct(b){Je&&Je(b)}function ht(){pt.stop()}function Qe(){pt.start()}const pt=new ph;pt.setAnimationLoop(ct),typeof self<"u"&&pt.setContext(self),this.setAnimationLoop=function(b){Je=b,Te.setAnimationLoop(b),b===null?pt.stop():pt.start()},Te.addEventListener("sessionstart",ht),Te.addEventListener("sessionend",Qe),this.render=function(b,z){if(z!==void 0&&z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),Te.enabled===!0&&Te.isPresenting===!0&&(Te.cameraAutoUpdate===!0&&Te.updateCamera(z),z=Te.getCamera()),b.isScene===!0&&b.onBeforeRender(S,b,z,w),p=_e.get(b,y.length),p.init(),y.push(p),be.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),Q.setFromProjectionMatrix(be),xe=this.localClippingEnabled,j=Ce.init(this.clippingPlanes,xe),_=he.get(b,d.length),_.init(),d.push(_),yn(b,z,0,S.sortObjects),_.finish(),S.sortObjects===!0&&_.sort(G,k),this.info.render.frame++,j===!0&&Ce.beginShadows();const Z=p.state.shadowsArray;if(se.render(Z,b,z),j===!0&&Ce.endShadows(),this.info.autoReset===!0&&this.info.reset(),Ge.render(_,b),p.setupLights(S._useLegacyLights),z.isArrayCamera){const ee=z.cameras;for(let K=0,Se=ee.length;K<Se;K++){const Pe=ee[K];vl(_,b,Pe,Pe.viewport)}}else vl(_,b,z);w!==null&&(M.updateMultisampleRenderTarget(w),M.updateRenderTargetMipmap(w)),b.isScene===!0&&b.onAfterRender(S,b,z),R.resetDefaultState(),$=-1,T=null,y.pop(),y.length>0?p=y[y.length-1]:p=null,d.pop(),d.length>0?_=d[d.length-1]:_=null};function yn(b,z,Z,ee){if(b.visible===!1)return;if(b.layers.test(z.layers)){if(b.isGroup)Z=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(z);else if(b.isLight)p.pushLight(b),b.castShadow&&p.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||Q.intersectsSprite(b)){ee&&Oe.setFromMatrixPosition(b.matrixWorld).applyMatrix4(be);const Pe=X.update(b),Be=b.material;Be.visible&&_.push(b,Pe,Be,Z,Oe.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||Q.intersectsObject(b))){const Pe=X.update(b),Be=b.material;if(ee&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),Oe.copy(b.boundingSphere.center)):(Pe.boundingSphere===null&&Pe.computeBoundingSphere(),Oe.copy(Pe.boundingSphere.center)),Oe.applyMatrix4(b.matrixWorld).applyMatrix4(be)),Array.isArray(Be)){const ze=Pe.groups;for(let je=0,Ve=ze.length;je<Ve;je++){const ke=ze[je],dt=Be[ke.materialIndex];dt&&dt.visible&&_.push(b,Pe,dt,Z,Oe.z,ke)}}else Be.visible&&_.push(b,Pe,Be,Z,Oe.z,null)}}const Se=b.children;for(let Pe=0,Be=Se.length;Pe<Be;Pe++)yn(Se[Pe],z,Z,ee)}function vl(b,z,Z,ee){const K=b.opaque,Se=b.transmissive,Pe=b.transparent;p.setupLightsView(Z),j===!0&&Ce.setGlobalState(S.clippingPlanes,Z),Se.length>0&&Uh(K,Se,z,Z),ee&&H.viewport(A.copy(ee)),K.length>0&&ns(K,z,Z),Se.length>0&&ns(Se,z,Z),Pe.length>0&&ns(Pe,z,Z),H.buffers.depth.setTest(!0),H.buffers.depth.setMask(!0),H.buffers.color.setMask(!0),H.setPolygonOffset(!1)}function Uh(b,z,Z,ee){if((Z.isScene===!0?Z.overrideMaterial:null)!==null)return;const Se=J.isWebGL2;ye===null&&(ye=new Bt(1,1,{generateMipmaps:!0,type:F.has("EXT_color_buffer_half_float")?cn:ci,minFilter:Sr,samples:Se?4:0})),S.getDrawingBufferSize(Ue),Se?ye.setSize(Ue.x,Ue.y):ye.setSize(Oo(Ue.x),Oo(Ue.y));const Pe=S.getRenderTarget();S.setRenderTarget(ye),S.getClearColor(le),I=S.getClearAlpha(),I<1&&S.setClearColor(16777215,.5),S.clear();const Be=S.toneMapping;S.toneMapping=kn,ns(b,Z,ee),M.updateMultisampleRenderTarget(ye),M.updateRenderTargetMipmap(ye);let ze=!1;for(let je=0,Ve=z.length;je<Ve;je++){const ke=z[je],dt=ke.object,Zt=ke.geometry,Mt=ke.material,Ln=ke.group;if(Mt.side===vn&&dt.layers.test(ee.layers)){const ot=Mt.side;Mt.side=Wt,Mt.needsUpdate=!0,xl(dt,Z,ee,Zt,Mt,Ln),Mt.side=ot,Mt.needsUpdate=!0,ze=!0}}ze===!0&&(M.updateMultisampleRenderTarget(ye),M.updateRenderTargetMipmap(ye)),S.setRenderTarget(Pe),S.setClearColor(le,I),S.toneMapping=Be}function ns(b,z,Z){const ee=z.isScene===!0?z.overrideMaterial:null;for(let K=0,Se=b.length;K<Se;K++){const Pe=b[K],Be=Pe.object,ze=Pe.geometry,je=ee===null?Pe.material:ee,Ve=Pe.group;Be.layers.test(Z.layers)&&xl(Be,z,Z,ze,je,Ve)}}function xl(b,z,Z,ee,K,Se){b.onBeforeRender(S,z,Z,ee,K,Se),b.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),K.onBeforeRender(S,z,Z,ee,b,Se),K.transparent===!0&&K.side===vn&&K.forceSinglePass===!1?(K.side=Wt,K.needsUpdate=!0,S.renderBufferDirect(Z,z,ee,K,b,Se),K.side=di,K.needsUpdate=!0,S.renderBufferDirect(Z,z,ee,K,b,Se),K.side=vn):S.renderBufferDirect(Z,z,ee,K,b,Se),b.onAfterRender(S,z,Z,ee,K,Se)}function is(b,z,Z){z.isScene!==!0&&(z=me);const ee=re.get(b),K=p.state.lights,Se=p.state.shadowsArray,Pe=K.state.version,Be=oe.getParameters(b,K.state,Se,z,Z),ze=oe.getProgramCacheKey(Be);let je=ee.programs;ee.environment=b.isMeshStandardMaterial?z.environment:null,ee.fog=z.fog,ee.envMap=(b.isMeshStandardMaterial?P:g).get(b.envMap||ee.environment),je===void 0&&(b.addEventListener("dispose",Me),je=new Map,ee.programs=je);let Ve=je.get(ze);if(Ve!==void 0){if(ee.currentProgram===Ve&&ee.lightsStateVersion===Pe)return Sl(b,Be),Ve}else Be.uniforms=oe.getUniforms(b),b.onBuild(Z,Be,S),b.onBeforeCompile(Be,S),Ve=oe.acquireProgram(Be,ze),je.set(ze,Ve),ee.uniforms=Be.uniforms;const ke=ee.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(ke.clippingPlanes=Ce.uniform),Sl(b,Be),ee.needsLights=Oh(b),ee.lightsStateVersion=Pe,ee.needsLights&&(ke.ambientLightColor.value=K.state.ambient,ke.lightProbe.value=K.state.probe,ke.directionalLights.value=K.state.directional,ke.directionalLightShadows.value=K.state.directionalShadow,ke.spotLights.value=K.state.spot,ke.spotLightShadows.value=K.state.spotShadow,ke.rectAreaLights.value=K.state.rectArea,ke.ltc_1.value=K.state.rectAreaLTC1,ke.ltc_2.value=K.state.rectAreaLTC2,ke.pointLights.value=K.state.point,ke.pointLightShadows.value=K.state.pointShadow,ke.hemisphereLights.value=K.state.hemi,ke.directionalShadowMap.value=K.state.directionalShadowMap,ke.directionalShadowMatrix.value=K.state.directionalShadowMatrix,ke.spotShadowMap.value=K.state.spotShadowMap,ke.spotLightMatrix.value=K.state.spotLightMatrix,ke.spotLightMap.value=K.state.spotLightMap,ke.pointShadowMap.value=K.state.pointShadowMap,ke.pointShadowMatrix.value=K.state.pointShadowMatrix),ee.currentProgram=Ve,ee.uniformsList=null,Ve}function Ml(b){if(b.uniformsList===null){const z=b.currentProgram.getUniforms();b.uniformsList=zs.seqWithValue(z.seq,b.uniforms)}return b.uniformsList}function Sl(b,z){const Z=re.get(b);Z.outputColorSpace=z.outputColorSpace,Z.batching=z.batching,Z.instancing=z.instancing,Z.instancingColor=z.instancingColor,Z.skinning=z.skinning,Z.morphTargets=z.morphTargets,Z.morphNormals=z.morphNormals,Z.morphColors=z.morphColors,Z.morphTargetsCount=z.morphTargetsCount,Z.numClippingPlanes=z.numClippingPlanes,Z.numIntersection=z.numClipIntersection,Z.vertexAlphas=z.vertexAlphas,Z.vertexTangents=z.vertexTangents,Z.toneMapping=z.toneMapping}function Ih(b,z,Z,ee,K){z.isScene!==!0&&(z=me),M.resetTextureUnits();const Se=z.fog,Pe=ee.isMeshStandardMaterial?z.environment:null,Be=w===null?S.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:Pn,ze=(ee.isMeshStandardMaterial?P:g).get(ee.envMap||Pe),je=ee.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,Ve=!!Z.attributes.tangent&&(!!ee.normalMap||ee.anisotropy>0),ke=!!Z.morphAttributes.position,dt=!!Z.morphAttributes.normal,Zt=!!Z.morphAttributes.color;let Mt=kn;ee.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(Mt=S.toneMapping);const Ln=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,ot=Ln!==void 0?Ln.length:0,Ke=re.get(ee),Ma=p.state.lights;if(j===!0&&(xe===!0||b!==T)){const on=b===T&&ee.id===$;Ce.setState(ee,b,on)}let ut=!1;ee.version===Ke.__version?(Ke.needsLights&&Ke.lightsStateVersion!==Ma.state.version||Ke.outputColorSpace!==Be||K.isBatchedMesh&&Ke.batching===!1||!K.isBatchedMesh&&Ke.batching===!0||K.isInstancedMesh&&Ke.instancing===!1||!K.isInstancedMesh&&Ke.instancing===!0||K.isSkinnedMesh&&Ke.skinning===!1||!K.isSkinnedMesh&&Ke.skinning===!0||K.isInstancedMesh&&Ke.instancingColor===!0&&K.instanceColor===null||K.isInstancedMesh&&Ke.instancingColor===!1&&K.instanceColor!==null||Ke.envMap!==ze||ee.fog===!0&&Ke.fog!==Se||Ke.numClippingPlanes!==void 0&&(Ke.numClippingPlanes!==Ce.numPlanes||Ke.numIntersection!==Ce.numIntersection)||Ke.vertexAlphas!==je||Ke.vertexTangents!==Ve||Ke.morphTargets!==ke||Ke.morphNormals!==dt||Ke.morphColors!==Zt||Ke.toneMapping!==Mt||J.isWebGL2===!0&&Ke.morphTargetsCount!==ot)&&(ut=!0):(ut=!0,Ke.__version=ee.version);let pi=Ke.currentProgram;ut===!0&&(pi=is(ee,z,K));let El=!1,Ar=!1,Sa=!1;const Ct=pi.getUniforms(),mi=Ke.uniforms;if(H.useProgram(pi.program)&&(El=!0,Ar=!0,Sa=!0),ee.id!==$&&($=ee.id,Ar=!0),El||T!==b){Ct.setValue(v,"projectionMatrix",b.projectionMatrix),Ct.setValue(v,"viewMatrix",b.matrixWorldInverse);const on=Ct.map.cameraPosition;on!==void 0&&on.setValue(v,Oe.setFromMatrixPosition(b.matrixWorld)),J.logarithmicDepthBuffer&&Ct.setValue(v,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(ee.isMeshPhongMaterial||ee.isMeshToonMaterial||ee.isMeshLambertMaterial||ee.isMeshBasicMaterial||ee.isMeshStandardMaterial||ee.isShaderMaterial)&&Ct.setValue(v,"isOrthographic",b.isOrthographicCamera===!0),T!==b&&(T=b,Ar=!0,Sa=!0)}if(K.isSkinnedMesh){Ct.setOptional(v,K,"bindMatrix"),Ct.setOptional(v,K,"bindMatrixInverse");const on=K.skeleton;on&&(J.floatVertexTextures?(on.boneTexture===null&&on.computeBoneTexture(),Ct.setValue(v,"boneTexture",on.boneTexture,M)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}K.isBatchedMesh&&(Ct.setOptional(v,K,"batchingTexture"),Ct.setValue(v,"batchingTexture",K._matricesTexture,M));const Ea=Z.morphAttributes;if((Ea.position!==void 0||Ea.normal!==void 0||Ea.color!==void 0&&J.isWebGL2===!0)&&Ne.update(K,Z,pi),(Ar||Ke.receiveShadow!==K.receiveShadow)&&(Ke.receiveShadow=K.receiveShadow,Ct.setValue(v,"receiveShadow",K.receiveShadow)),ee.isMeshGouraudMaterial&&ee.envMap!==null&&(mi.envMap.value=ze,mi.flipEnvMap.value=ze.isCubeTexture&&ze.isRenderTargetTexture===!1?-1:1),Ar&&(Ct.setValue(v,"toneMappingExposure",S.toneMappingExposure),Ke.needsLights&&Nh(mi,Sa),Se&&ee.fog===!0&&ae.refreshFogUniforms(mi,Se),ae.refreshMaterialUniforms(mi,ee,O,W,ye),zs.upload(v,Ml(Ke),mi,M)),ee.isShaderMaterial&&ee.uniformsNeedUpdate===!0&&(zs.upload(v,Ml(Ke),mi,M),ee.uniformsNeedUpdate=!1),ee.isSpriteMaterial&&Ct.setValue(v,"center",K.center),Ct.setValue(v,"modelViewMatrix",K.modelViewMatrix),Ct.setValue(v,"normalMatrix",K.normalMatrix),Ct.setValue(v,"modelMatrix",K.matrixWorld),ee.isShaderMaterial||ee.isRawShaderMaterial){const on=ee.uniformsGroups;for(let ya=0,Fh=on.length;ya<Fh;ya++)if(J.isWebGL2){const yl=on[ya];de.update(yl,pi),de.bind(yl,pi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return pi}function Nh(b,z){b.ambientLightColor.needsUpdate=z,b.lightProbe.needsUpdate=z,b.directionalLights.needsUpdate=z,b.directionalLightShadows.needsUpdate=z,b.pointLights.needsUpdate=z,b.pointLightShadows.needsUpdate=z,b.spotLights.needsUpdate=z,b.spotLightShadows.needsUpdate=z,b.rectAreaLights.needsUpdate=z,b.hemisphereLights.needsUpdate=z}function Oh(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return D},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(b,z,Z){re.get(b.texture).__webglTexture=z,re.get(b.depthTexture).__webglTexture=Z;const ee=re.get(b);ee.__hasExternalTextures=!0,ee.__hasExternalTextures&&(ee.__autoAllocateDepthBuffer=Z===void 0,ee.__autoAllocateDepthBuffer||F.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),ee.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(b,z){const Z=re.get(b);Z.__webglFramebuffer=z,Z.__useDefaultFramebuffer=z===void 0},this.setRenderTarget=function(b,z=0,Z=0){w=b,D=z,C=Z;let ee=!0,K=null,Se=!1,Pe=!1;if(b){const ze=re.get(b);ze.__useDefaultFramebuffer!==void 0?(H.bindFramebuffer(v.FRAMEBUFFER,null),ee=!1):ze.__webglFramebuffer===void 0?M.setupRenderTarget(b):ze.__hasExternalTextures&&M.rebindTextures(b,re.get(b.texture).__webglTexture,re.get(b.depthTexture).__webglTexture);const je=b.texture;(je.isData3DTexture||je.isDataArrayTexture||je.isCompressedArrayTexture)&&(Pe=!0);const Ve=re.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Ve[z])?K=Ve[z][Z]:K=Ve[z],Se=!0):J.isWebGL2&&b.samples>0&&M.useMultisampledRTT(b)===!1?K=re.get(b).__webglMultisampledFramebuffer:Array.isArray(Ve)?K=Ve[Z]:K=Ve,A.copy(b.viewport),Y.copy(b.scissor),te=b.scissorTest}else A.copy(ne).multiplyScalar(O).floor(),Y.copy(ue).multiplyScalar(O).floor(),te=ce;if(H.bindFramebuffer(v.FRAMEBUFFER,K)&&J.drawBuffers&&ee&&H.drawBuffers(b,K),H.viewport(A),H.scissor(Y),H.setScissorTest(te),Se){const ze=re.get(b.texture);v.framebufferTexture2D(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_CUBE_MAP_POSITIVE_X+z,ze.__webglTexture,Z)}else if(Pe){const ze=re.get(b.texture),je=z||0;v.framebufferTextureLayer(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,ze.__webglTexture,Z||0,je)}$=-1},this.readRenderTargetPixels=function(b,z,Z,ee,K,Se,Pe){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Be=re.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Pe!==void 0&&(Be=Be[Pe]),Be){H.bindFramebuffer(v.FRAMEBUFFER,Be);try{const ze=b.texture,je=ze.format,Ve=ze.type;if(je!==xn&&ge.convert(je)!==v.getParameter(v.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const ke=Ve===cn&&(F.has("EXT_color_buffer_half_float")||J.isWebGL2&&F.has("EXT_color_buffer_float"));if(Ve!==ci&&ge.convert(Ve)!==v.getParameter(v.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Ve===ai&&(J.isWebGL2||F.has("OES_texture_float")||F.has("WEBGL_color_buffer_float")))&&!ke){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=b.width-ee&&Z>=0&&Z<=b.height-K&&v.readPixels(z,Z,ee,K,ge.convert(je),ge.convert(Ve),Se)}finally{const ze=w!==null?re.get(w).__webglFramebuffer:null;H.bindFramebuffer(v.FRAMEBUFFER,ze)}}},this.copyFramebufferToTexture=function(b,z,Z=0){const ee=Math.pow(2,-Z),K=Math.floor(z.image.width*ee),Se=Math.floor(z.image.height*ee);M.setTexture2D(z,0),v.copyTexSubImage2D(v.TEXTURE_2D,Z,0,0,b.x,b.y,K,Se),H.unbindTexture()},this.copyTextureToTexture=function(b,z,Z,ee=0){const K=z.image.width,Se=z.image.height,Pe=ge.convert(Z.format),Be=ge.convert(Z.type);M.setTexture2D(Z,0),v.pixelStorei(v.UNPACK_FLIP_Y_WEBGL,Z.flipY),v.pixelStorei(v.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),v.pixelStorei(v.UNPACK_ALIGNMENT,Z.unpackAlignment),z.isDataTexture?v.texSubImage2D(v.TEXTURE_2D,ee,b.x,b.y,K,Se,Pe,Be,z.image.data):z.isCompressedTexture?v.compressedTexSubImage2D(v.TEXTURE_2D,ee,b.x,b.y,z.mipmaps[0].width,z.mipmaps[0].height,Pe,z.mipmaps[0].data):v.texSubImage2D(v.TEXTURE_2D,ee,b.x,b.y,Pe,Be,z.image),ee===0&&Z.generateMipmaps&&v.generateMipmap(v.TEXTURE_2D),H.unbindTexture()},this.copyTextureToTexture3D=function(b,z,Z,ee,K=0){if(S.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Se=b.max.x-b.min.x+1,Pe=b.max.y-b.min.y+1,Be=b.max.z-b.min.z+1,ze=ge.convert(ee.format),je=ge.convert(ee.type);let Ve;if(ee.isData3DTexture)M.setTexture3D(ee,0),Ve=v.TEXTURE_3D;else if(ee.isDataArrayTexture||ee.isCompressedArrayTexture)M.setTexture2DArray(ee,0),Ve=v.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}v.pixelStorei(v.UNPACK_FLIP_Y_WEBGL,ee.flipY),v.pixelStorei(v.UNPACK_PREMULTIPLY_ALPHA_WEBGL,ee.premultiplyAlpha),v.pixelStorei(v.UNPACK_ALIGNMENT,ee.unpackAlignment);const ke=v.getParameter(v.UNPACK_ROW_LENGTH),dt=v.getParameter(v.UNPACK_IMAGE_HEIGHT),Zt=v.getParameter(v.UNPACK_SKIP_PIXELS),Mt=v.getParameter(v.UNPACK_SKIP_ROWS),Ln=v.getParameter(v.UNPACK_SKIP_IMAGES),ot=Z.isCompressedTexture?Z.mipmaps[K]:Z.image;v.pixelStorei(v.UNPACK_ROW_LENGTH,ot.width),v.pixelStorei(v.UNPACK_IMAGE_HEIGHT,ot.height),v.pixelStorei(v.UNPACK_SKIP_PIXELS,b.min.x),v.pixelStorei(v.UNPACK_SKIP_ROWS,b.min.y),v.pixelStorei(v.UNPACK_SKIP_IMAGES,b.min.z),Z.isDataTexture||Z.isData3DTexture?v.texSubImage3D(Ve,K,z.x,z.y,z.z,Se,Pe,Be,ze,je,ot.data):Z.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),v.compressedTexSubImage3D(Ve,K,z.x,z.y,z.z,Se,Pe,Be,ze,ot.data)):v.texSubImage3D(Ve,K,z.x,z.y,z.z,Se,Pe,Be,ze,je,ot),v.pixelStorei(v.UNPACK_ROW_LENGTH,ke),v.pixelStorei(v.UNPACK_IMAGE_HEIGHT,dt),v.pixelStorei(v.UNPACK_SKIP_PIXELS,Zt),v.pixelStorei(v.UNPACK_SKIP_ROWS,Mt),v.pixelStorei(v.UNPACK_SKIP_IMAGES,Ln),K===0&&ee.generateMipmaps&&v.generateMipmap(Ve),H.unbindTexture()},this.initTexture=function(b){b.isCubeTexture?M.setTextureCube(b,0):b.isData3DTexture?M.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?M.setTexture2DArray(b,0):M.setTexture2D(b,0),H.unbindTexture()},this.resetState=function(){D=0,C=0,w=null,H.reset(),R.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Vn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===ll?"display-p3":"srgb",t.unpackColorSpace=nt.workingColorSpace===pa?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===wt?Ci:eh}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Ci?wt:Pn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class cM extends Eh{}cM.prototype.isWebGL1Renderer=!0;class uM extends Tt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class fM{constructor(e,t){this.isInterleavedBuffer=!0,this.array=e,this.stride=t,this.count=e!==void 0?e.length/t:0,this.usage=Uo,this._updateRange={offset:0,count:-1},this.updateRanges=[],this.version=0,this.uuid=ui()}onUploadCallback(){}set needsUpdate(e){e===!0&&this.version++}get updateRange(){return console.warn("THREE.InterleavedBuffer: updateRange() is deprecated and will be removed in r169. Use addUpdateRange() instead."),this._updateRange}setUsage(e){return this.usage=e,this}addUpdateRange(e,t){this.updateRanges.push({start:e,count:t})}clearUpdateRanges(){this.updateRanges.length=0}copy(e){return this.array=new e.array.constructor(e.array),this.count=e.count,this.stride=e.stride,this.usage=e.usage,this}copyAt(e,t,i){e*=this.stride,i*=t.stride;for(let r=0,s=this.stride;r<s;r++)this.array[e+r]=t.array[i+r];return this}set(e,t=0){return this.array.set(e,t),this}clone(e){e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=ui()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=this.array.slice(0).buffer);const t=new this.array.constructor(e.arrayBuffers[this.array.buffer._uuid]),i=new this.constructor(t,this.stride);return i.setUsage(this.usage),i}onUpload(e){return this.onUploadCallback=e,this}toJSON(e){return e.arrayBuffers===void 0&&(e.arrayBuffers={}),this.array.buffer._uuid===void 0&&(this.array.buffer._uuid=ui()),e.arrayBuffers[this.array.buffer._uuid]===void 0&&(e.arrayBuffers[this.array.buffer._uuid]=Array.from(new Uint32Array(this.array.buffer))),{uuid:this.uuid,buffer:this.array.buffer._uuid,type:this.array.constructor.name,stride:this.stride}}}const It=new N;class ta{constructor(e,t,i,r=!1){this.isInterleavedBufferAttribute=!0,this.name="",this.data=e,this.itemSize=t,this.offset=i,this.normalized=r}get count(){return this.data.count}get array(){return this.data.array}set needsUpdate(e){this.data.needsUpdate=e}applyMatrix4(e){for(let t=0,i=this.data.count;t<i;t++)It.fromBufferAttribute(this,t),It.applyMatrix4(e),this.setXYZ(t,It.x,It.y,It.z);return this}applyNormalMatrix(e){for(let t=0,i=this.count;t<i;t++)It.fromBufferAttribute(this,t),It.applyNormalMatrix(e),this.setXYZ(t,It.x,It.y,It.z);return this}transformDirection(e){for(let t=0,i=this.count;t<i;t++)It.fromBufferAttribute(this,t),It.transformDirection(e),this.setXYZ(t,It.x,It.y,It.z);return this}setX(e,t){return this.normalized&&(t=it(t,this.array)),this.data.array[e*this.data.stride+this.offset]=t,this}setY(e,t){return this.normalized&&(t=it(t,this.array)),this.data.array[e*this.data.stride+this.offset+1]=t,this}setZ(e,t){return this.normalized&&(t=it(t,this.array)),this.data.array[e*this.data.stride+this.offset+2]=t,this}setW(e,t){return this.normalized&&(t=it(t,this.array)),this.data.array[e*this.data.stride+this.offset+3]=t,this}getX(e){let t=this.data.array[e*this.data.stride+this.offset];return this.normalized&&(t=Gn(t,this.array)),t}getY(e){let t=this.data.array[e*this.data.stride+this.offset+1];return this.normalized&&(t=Gn(t,this.array)),t}getZ(e){let t=this.data.array[e*this.data.stride+this.offset+2];return this.normalized&&(t=Gn(t,this.array)),t}getW(e){let t=this.data.array[e*this.data.stride+this.offset+3];return this.normalized&&(t=Gn(t,this.array)),t}setXY(e,t,i){return e=e*this.data.stride+this.offset,this.normalized&&(t=it(t,this.array),i=it(i,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this}setXYZ(e,t,i,r){return e=e*this.data.stride+this.offset,this.normalized&&(t=it(t,this.array),i=it(i,this.array),r=it(r,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this}setXYZW(e,t,i,r,s){return e=e*this.data.stride+this.offset,this.normalized&&(t=it(t,this.array),i=it(i,this.array),r=it(r,this.array),s=it(s,this.array)),this.data.array[e+0]=t,this.data.array[e+1]=i,this.data.array[e+2]=r,this.data.array[e+3]=s,this}clone(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.clone(): Cloning an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return new En(new this.array.constructor(t),this.itemSize,this.normalized)}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.clone(e)),new ta(e.interleavedBuffers[this.data.uuid],this.itemSize,this.offset,this.normalized)}toJSON(e){if(e===void 0){console.log("THREE.InterleavedBufferAttribute.toJSON(): Serializing an interleaved buffer attribute will de-interleave buffer data.");const t=[];for(let i=0;i<this.count;i++){const r=i*this.data.stride+this.offset;for(let s=0;s<this.itemSize;s++)t.push(this.data.array[r+s])}return{itemSize:this.itemSize,type:this.array.constructor.name,array:t,normalized:this.normalized}}else return e.interleavedBuffers===void 0&&(e.interleavedBuffers={}),e.interleavedBuffers[this.data.uuid]===void 0&&(e.interleavedBuffers[this.data.uuid]=this.data.toJSON(e)),{isInterleavedBufferAttribute:!0,itemSize:this.itemSize,data:this.data.uuid,offset:this.offset,normalized:this.normalized}}}class yh extends Ui{constructor(e){super(),this.isSpriteMaterial=!0,this.type="SpriteMaterial",this.color=new Ye(16777215),this.map=null,this.alphaMap=null,this.rotation=0,this.sizeAttenuation=!0,this.transparent=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.rotation=e.rotation,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}let Qi;const Ur=new N,er=new N,tr=new N,nr=new Ae,Ir=new Ae,Th=new ft,Ps=new N,Nr=new N,Ls=new N,gu=new Ae,ho=new Ae,_u=new Ae;class hM extends Tt{constructor(e=new yh){if(super(),this.isSprite=!0,this.type="Sprite",Qi===void 0){Qi=new an;const t=new Float32Array([-.5,-.5,0,0,0,.5,-.5,0,1,0,.5,.5,0,1,1,-.5,.5,0,0,1]),i=new fM(t,5);Qi.setIndex([0,1,2,0,2,3]),Qi.setAttribute("position",new ta(i,3,0,!1)),Qi.setAttribute("uv",new ta(i,2,3,!1))}this.geometry=Qi,this.material=e,this.center=new Ae(.5,.5)}raycast(e,t){e.camera===null&&console.error('THREE.Sprite: "Raycaster.camera" needs to be set in order to raycast against sprites.'),er.setFromMatrixScale(this.matrixWorld),Th.copy(e.camera.matrixWorld),this.modelViewMatrix.multiplyMatrices(e.camera.matrixWorldInverse,this.matrixWorld),tr.setFromMatrixPosition(this.modelViewMatrix),e.camera.isPerspectiveCamera&&this.material.sizeAttenuation===!1&&er.multiplyScalar(-tr.z);const i=this.material.rotation;let r,s;i!==0&&(s=Math.cos(i),r=Math.sin(i));const a=this.center;Ds(Ps.set(-.5,-.5,0),tr,a,er,r,s),Ds(Nr.set(.5,-.5,0),tr,a,er,r,s),Ds(Ls.set(.5,.5,0),tr,a,er,r,s),gu.set(0,0),ho.set(1,0),_u.set(1,1);let o=e.ray.intersectTriangle(Ps,Nr,Ls,!1,Ur);if(o===null&&(Ds(Nr.set(-.5,.5,0),tr,a,er,r,s),ho.set(0,1),o=e.ray.intersectTriangle(Ps,Ls,Nr,!1,Ur),o===null))return;const l=e.ray.origin.distanceTo(Ur);l<e.near||l>e.far||t.push({distance:l,point:Ur.clone(),uv:un.getInterpolation(Ur,Ps,Nr,Ls,gu,ho,_u,new Ae),face:null,object:this})}copy(e,t){return super.copy(e,t),e.center!==void 0&&this.center.copy(e.center),this.material=e.material,this}}function Ds(n,e,t,i,r,s){nr.subVectors(n,t).addScalar(.5).multiply(i),r!==void 0?(Ir.x=s*nr.x-r*nr.y,Ir.y=r*nr.x+s*nr.y):Ir.copy(nr),n.copy(e),n.x+=Ir.x,n.y+=Ir.y,n.applyMatrix4(Th)}class bh extends Ui{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Ye(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const vu=new N,xu=new N,Mu=new ft,po=new ga,Us=new ma;class dM extends Tt{constructor(e=new an,t=new bh){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[0];for(let r=1,s=t.count;r<s;r++)vu.fromBufferAttribute(t,r-1),xu.fromBufferAttribute(t,r),i[r]=i[r-1],i[r]+=vu.distanceTo(xu);e.setAttribute("lineDistance",new bt(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,a=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),Us.copy(i.boundingSphere),Us.applyMatrix4(r),Us.radius+=s,e.ray.intersectsSphere(Us)===!1)return;Mu.copy(r).invert(),po.copy(e.ray).applyMatrix4(Mu);const o=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=new N,u=new N,f=new N,h=new N,m=this.isLineSegments?2:1,x=i.index,p=i.attributes.position;if(x!==null){const d=Math.max(0,a.start),y=Math.min(x.count,a.start+a.count);for(let S=d,E=y-1;S<E;S+=m){const D=x.getX(S),C=x.getX(S+1);if(c.fromBufferAttribute(p,D),u.fromBufferAttribute(p,C),po.distanceSqToSegment(c,u,h,f)>l)continue;h.applyMatrix4(this.matrixWorld);const $=e.ray.origin.distanceTo(h);$<e.near||$>e.far||t.push({distance:$,point:f.clone().applyMatrix4(this.matrixWorld),index:S,face:null,faceIndex:null,object:this})}}else{const d=Math.max(0,a.start),y=Math.min(p.count,a.start+a.count);for(let S=d,E=y-1;S<E;S+=m){if(c.fromBufferAttribute(p,S),u.fromBufferAttribute(p,S+1),po.distanceSqToSegment(c,u,h,f)>l)continue;h.applyMatrix4(this.matrixWorld);const C=e.ray.origin.distanceTo(h);C<e.near||C>e.far||t.push({distance:C,point:f.clone().applyMatrix4(this.matrixWorld),index:S,face:null,faceIndex:null,object:this})}}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,a=r.length;s<a;s++){const o=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=s}}}}}const Su=new N,Eu=new N;class pM extends dM{constructor(e,t){super(e,t),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const t=e.attributes.position,i=[];for(let r=0,s=t.count;r<s;r+=2)Su.fromBufferAttribute(t,r),Eu.fromBufferAttribute(t,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+Su.distanceTo(Eu);e.setAttribute("lineDistance",new bt(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class mM extends Xt{constructor(e,t,i,r,s,a,o,l,c){super(e,t,i,r,s,a,o,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class pl extends an{constructor(e=[],t=[],i=1,r=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:e,indices:t,radius:i,detail:r};const s=[],a=[];o(r),c(i),u(),this.setAttribute("position",new bt(s,3)),this.setAttribute("normal",new bt(s.slice(),3)),this.setAttribute("uv",new bt(a,2)),r===0?this.computeVertexNormals():this.normalizeNormals();function o(y){const S=new N,E=new N,D=new N;for(let C=0;C<t.length;C+=3)m(t[C+0],S),m(t[C+1],E),m(t[C+2],D),l(S,E,D,y)}function l(y,S,E,D){const C=D+1,w=[];for(let $=0;$<=C;$++){w[$]=[];const T=y.clone().lerp(E,$/C),A=S.clone().lerp(E,$/C),Y=C-$;for(let te=0;te<=Y;te++)te===0&&$===C?w[$][te]=T:w[$][te]=T.clone().lerp(A,te/Y)}for(let $=0;$<C;$++)for(let T=0;T<2*(C-$)-1;T++){const A=Math.floor(T/2);T%2===0?(h(w[$][A+1]),h(w[$+1][A]),h(w[$][A])):(h(w[$][A+1]),h(w[$+1][A+1]),h(w[$+1][A]))}}function c(y){const S=new N;for(let E=0;E<s.length;E+=3)S.x=s[E+0],S.y=s[E+1],S.z=s[E+2],S.normalize().multiplyScalar(y),s[E+0]=S.x,s[E+1]=S.y,s[E+2]=S.z}function u(){const y=new N;for(let S=0;S<s.length;S+=3){y.x=s[S+0],y.y=s[S+1],y.z=s[S+2];const E=p(y)/2/Math.PI+.5,D=d(y)/Math.PI+.5;a.push(E,1-D)}x(),f()}function f(){for(let y=0;y<a.length;y+=6){const S=a[y+0],E=a[y+2],D=a[y+4],C=Math.max(S,E,D),w=Math.min(S,E,D);C>.9&&w<.1&&(S<.2&&(a[y+0]+=1),E<.2&&(a[y+2]+=1),D<.2&&(a[y+4]+=1))}}function h(y){s.push(y.x,y.y,y.z)}function m(y,S){const E=y*3;S.x=e[E+0],S.y=e[E+1],S.z=e[E+2]}function x(){const y=new N,S=new N,E=new N,D=new N,C=new Ae,w=new Ae,$=new Ae;for(let T=0,A=0;T<s.length;T+=9,A+=6){y.set(s[T+0],s[T+1],s[T+2]),S.set(s[T+3],s[T+4],s[T+5]),E.set(s[T+6],s[T+7],s[T+8]),C.set(a[A+0],a[A+1]),w.set(a[A+2],a[A+3]),$.set(a[A+4],a[A+5]),D.copy(y).add(S).add(E).divideScalar(3);const Y=p(D);_(C,A+0,y,Y),_(w,A+2,S,Y),_($,A+4,E,Y)}}function _(y,S,E,D){D<0&&y.x===1&&(a[S]=y.x-1),E.x===0&&E.z===0&&(a[S]=D/2/Math.PI+.5)}function p(y){return Math.atan2(y.z,-y.x)}function d(y){return Math.atan2(-y.y,Math.sqrt(y.x*y.x+y.z*y.z))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new pl(e.vertices,e.indices,e.radius,e.details)}}class ml extends pl{constructor(e=1,t=0){const i=(1+Math.sqrt(5))/2,r=[-1,i,0,1,i,0,-1,-i,0,1,-i,0,0,-1,i,0,1,i,0,-1,-i,0,1,-i,i,0,-1,i,0,1,-i,0,-1,-i,0,1],s=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(r,s,e,t),this.type="IcosahedronGeometry",this.parameters={radius:e,detail:t}}static fromJSON(e){return new ml(e.radius,e.detail)}}class Tr extends an{constructor(e=1,t=32,i=16,r=0,s=Math.PI*2,a=0,o=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:t,heightSegments:i,phiStart:r,phiLength:s,thetaStart:a,thetaLength:o},t=Math.max(3,Math.floor(t)),i=Math.max(2,Math.floor(i));const l=Math.min(a+o,Math.PI);let c=0;const u=[],f=new N,h=new N,m=[],x=[],_=[],p=[];for(let d=0;d<=i;d++){const y=[],S=d/i;let E=0;d===0&&a===0?E=.5/t:d===i&&l===Math.PI&&(E=-.5/t);for(let D=0;D<=t;D++){const C=D/t;f.x=-e*Math.cos(r+C*s)*Math.sin(a+S*o),f.y=e*Math.cos(a+S*o),f.z=e*Math.sin(r+C*s)*Math.sin(a+S*o),x.push(f.x,f.y,f.z),h.copy(f).normalize(),_.push(h.x,h.y,h.z),p.push(C+E,1-S),y.push(c++)}u.push(y)}for(let d=0;d<i;d++)for(let y=0;y<t;y++){const S=u[d][y+1],E=u[d][y],D=u[d+1][y],C=u[d+1][y+1];(d!==0||a>0)&&m.push(S,E,C),(d!==i-1||l<Math.PI)&&m.push(E,D,C)}this.setIndex(m),this.setAttribute("position",new bt(x,3)),this.setAttribute("normal",new bt(_,3)),this.setAttribute("uv",new bt(p,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Tr(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class gl extends Ui{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new Ye(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Ye(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=nh,this.normalScale=new Ae(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}const yu={enabled:!1,files:{},add:function(n,e){this.enabled!==!1&&(this.files[n]=e)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class gM{constructor(e,t,i){const r=this;let s=!1,a=0,o=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=i,this.itemStart=function(u){o++,s===!1&&r.onStart!==void 0&&r.onStart(u,a,o),s=!0},this.itemEnd=function(u){a++,r.onProgress!==void 0&&r.onProgress(u,a,o),a===o&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(u){r.onError!==void 0&&r.onError(u)},this.resolveURL=function(u){return l?l(u):u},this.setURLModifier=function(u){return l=u,this},this.addHandler=function(u,f){return c.push(u,f),this},this.removeHandler=function(u){const f=c.indexOf(u);return f!==-1&&c.splice(f,2),this},this.getHandler=function(u){for(let f=0,h=c.length;f<h;f+=2){const m=c[f],x=c[f+1];if(m.global&&(m.lastIndex=0),m.test(u))return x}return null}}}const _M=new gM;class _l{constructor(e){this.manager=e!==void 0?e:_M,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const i=this;return new Promise(function(r,s){i.load(e,r,t,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}_l.DEFAULT_MATERIAL_NAME="__DEFAULT";class vM extends _l{constructor(e){super(e)}load(e,t,i,r){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=this,a=yu.get(e);if(a!==void 0)return s.manager.itemStart(e),setTimeout(function(){t&&t(a),s.manager.itemEnd(e)},0),a;const o=$r("img");function l(){u(),yu.add(e,this),t&&t(this),s.manager.itemEnd(e)}function c(f){u(),r&&r(f),s.manager.itemError(e),s.manager.itemEnd(e)}function u(){o.removeEventListener("load",l,!1),o.removeEventListener("error",c,!1)}return o.addEventListener("load",l,!1),o.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(o.crossOrigin=this.crossOrigin),s.manager.itemStart(e),o.src=e,o}}class Ah extends _l{constructor(e){super(e)}load(e,t,i,r){const s=new Xt,a=new vM(this.manager);return a.setCrossOrigin(this.crossOrigin),a.setPath(this.path),a.load(e,function(o){s.image=o,s.needsUpdate=!0,t!==void 0&&t(s)},i,r),s}}class wh extends Tt{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ye(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}const mo=new ft,Tu=new N,bu=new N;class xM{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ae(512,512),this.map=null,this.mapPass=null,this.matrix=new ft,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new fl,this._frameExtents=new Ae(1,1),this._viewportCount=1,this._viewports=[new yt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;Tu.setFromMatrixPosition(e.matrixWorld),t.position.copy(Tu),bu.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(bu),t.updateMatrixWorld(),mo.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(mo),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(mo)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class MM extends xM{constructor(){super(new hl(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class SM extends wh{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Tt.DEFAULT_UP),this.updateMatrix(),this.target=new Tt,this.shadow=new MM}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class EM extends wh{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class yM{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Au(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=Au();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function Au(){return(typeof performance>"u"?Date:performance).now()}class TM{constructor(e,t,i=0,r=1/0){this.ray=new ga(e,t),this.near=i,this.far=r,this.camera=null,this.layers=new cl,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,t){this.ray.set(e,t)}setFromCamera(e,t){t.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(t).sub(this.ray.origin).normalize(),this.camera=t):t.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(t.near+t.far)/(t.near-t.far)).unproject(t),this.ray.direction.set(0,0,-1).transformDirection(t.matrixWorld),this.camera=t):console.error("THREE.Raycaster: Unsupported camera type: "+t.type)}intersectObject(e,t=!0,i=[]){return Bo(e,this,i,t),i.sort(wu),i}intersectObjects(e,t=!0,i=[]){for(let r=0,s=e.length;r<s;r++)Bo(e[r],this,i,t);return i.sort(wu),i}}function wu(n,e){return n.distance-e.distance}function Bo(n,e,t,i){if(n.layers.test(e.layers)&&n.raycast(e,t),i===!0){const r=n.children;for(let s=0,a=r.length;s<a;s++)Bo(r[s],e,t,!0)}}class Ru{constructor(e=1,t=0,i=0){return this.radius=e,this.phi=t,this.theta=i,this}set(e,t,i){return this.radius=e,this.phi=t,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,i){return this.radius=Math.sqrt(e*e+t*t+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Ht(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:al}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=al);const Rh={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}getEdgeDetectionMaterial(){return new Vt({uniforms:{maskTexture:{value:null},texSize:{value:new Ae(.5,.5)},visibleEdgeColor:{value:new N(1,1,1)},hiddenEdgeColor:{value:new N(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}getSeperableBlurMaterial(e){return new Vt({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new Ae(.5,.5)},direction:{value:new Ae(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`,blending:js,depthTest:!1,depthWrite:!1,transparent:!0})}}oi.BlurDirectionX=new Ae(1,0);oi.BlurDirectionY=new Ae(0,1);const Pu={type:"change"},go={type:"start"},Lu={type:"end"},Is=new ga,Du=new ii,DM=Math.cos(70*sg.DEG2RAD);class UM extends Di{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new N,this.cursor=new N,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ni.ROTATE,MIDDLE:Ni.DOLLY,RIGHT:Ni.PAN},this.touches={ONE:Oi.ROTATE,TWO:Oi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(R){R.addEventListener("keydown",_e),this._domElementKeyEvents=R},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",_e),this._domElementKeyEvents=null},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(Pu),i.update(),s=r.NONE},this.update=function(){const R=new N,de=new Pi().setFromUnitVectors(e.up,new N(0,1,0)),Re=de.clone().invert(),Te=new N,fe=new Pi,U=new N,pe=2*Math.PI;return function(Fe=null){const De=i.object.position;R.copy(De).sub(i.target),R.applyQuaternion(de),o.setFromVector3(R),i.autoRotate&&s===r.NONE&&te(A(Fe)),i.enableDamping?(o.theta+=l.theta*i.dampingFactor,o.phi+=l.phi*i.dampingFactor):(o.theta+=l.theta,o.phi+=l.phi);let Ze=i.minAzimuthAngle,Je=i.maxAzimuthAngle;isFinite(Ze)&&isFinite(Je)&&(Ze<-Math.PI?Ze+=pe:Ze>Math.PI&&(Ze-=pe),Je<-Math.PI?Je+=pe:Je>Math.PI&&(Je-=pe),Ze<=Je?o.theta=Math.max(Ze,Math.min(Je,o.theta)):o.theta=o.theta>(Ze+Je)/2?Math.max(Ze,o.theta):Math.min(Je,o.theta)),o.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,o.phi)),o.makeSafe(),i.enableDamping===!0?i.target.addScaledVector(u,i.dampingFactor):i.target.add(u),i.target.sub(i.cursor),i.target.clampLength(i.minTargetRadius,i.maxTargetRadius),i.target.add(i.cursor),i.zoomToCursor&&C||i.object.isOrthographicCamera?o.radius=ne(o.radius):o.radius=ne(o.radius*c),R.setFromSpherical(o),R.applyQuaternion(Re),De.copy(i.target).add(R),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,u.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),u.set(0,0,0));let ct=!1;if(i.zoomToCursor&&C){let ht=null;if(i.object.isPerspectiveCamera){const Qe=R.length();ht=ne(Qe*c);const pt=Qe-ht;i.object.position.addScaledVector(E,pt),i.object.updateMatrixWorld()}else if(i.object.isOrthographicCamera){const Qe=new N(D.x,D.y,0);Qe.unproject(i.object),i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),ct=!0;const pt=new N(D.x,D.y,0);pt.unproject(i.object),i.object.position.sub(pt).add(Qe),i.object.updateMatrixWorld(),ht=R.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),i.zoomToCursor=!1;ht!==null&&(this.screenSpacePanning?i.target.set(0,0,-1).transformDirection(i.object.matrix).multiplyScalar(ht).add(i.object.position):(Is.origin.copy(i.object.position),Is.direction.set(0,0,-1).transformDirection(i.object.matrix),Math.abs(i.object.up.dot(Is.direction))<DM?e.lookAt(i.target):(Du.setFromNormalAndCoplanarPoint(i.object.up,i.target),Is.intersectPlane(Du,i.target))))}else i.object.isOrthographicCamera&&(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/c)),i.object.updateProjectionMatrix(),ct=!0);return c=1,C=!1,ct||Te.distanceToSquared(i.object.position)>a||8*(1-fe.dot(i.object.quaternion))>a||U.distanceToSquared(i.target)>0?(i.dispatchEvent(Pu),Te.copy(i.object.position),fe.copy(i.object.quaternion),U.copy(i.target),!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",Ge),i.domElement.removeEventListener("pointerdown",M),i.domElement.removeEventListener("pointercancel",P),i.domElement.removeEventListener("wheel",X),i.domElement.removeEventListener("pointermove",g),i.domElement.removeEventListener("pointerup",P),i._domElementKeyEvents!==null&&(i._domElementKeyEvents.removeEventListener("keydown",_e),i._domElementKeyEvents=null)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const a=1e-6,o=new Ru,l=new Ru;let c=1;const u=new N,f=new Ae,h=new Ae,m=new Ae,x=new Ae,_=new Ae,p=new Ae,d=new Ae,y=new Ae,S=new Ae,E=new N,D=new Ae;let C=!1;const w=[],$={};let T=!1;function A(R){return R!==null?2*Math.PI/60*i.autoRotateSpeed*R:2*Math.PI/60/60*i.autoRotateSpeed}function Y(R){const de=Math.abs(R*.01);return Math.pow(.95,i.zoomSpeed*de)}function te(R){l.theta-=R}function le(R){l.phi-=R}const I=function(){const R=new N;return function(Re,Te){R.setFromMatrixColumn(Te,0),R.multiplyScalar(-Re),u.add(R)}}(),V=function(){const R=new N;return function(Re,Te){i.screenSpacePanning===!0?R.setFromMatrixColumn(Te,1):(R.setFromMatrixColumn(Te,0),R.crossVectors(i.object.up,R)),R.multiplyScalar(Re),u.add(R)}}(),W=function(){const R=new N;return function(Re,Te){const fe=i.domElement;if(i.object.isPerspectiveCamera){const U=i.object.position;R.copy(U).sub(i.target);let pe=R.length();pe*=Math.tan(i.object.fov/2*Math.PI/180),I(2*Re*pe/fe.clientHeight,i.object.matrix),V(2*Te*pe/fe.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?(I(Re*(i.object.right-i.object.left)/i.object.zoom/fe.clientWidth,i.object.matrix),V(Te*(i.object.top-i.object.bottom)/i.object.zoom/fe.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function O(R){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c/=R:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function G(R){i.object.isPerspectiveCamera||i.object.isOrthographicCamera?c*=R:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function k(R,de){if(!i.zoomToCursor)return;C=!0;const Re=i.domElement.getBoundingClientRect(),Te=R-Re.left,fe=de-Re.top,U=Re.width,pe=Re.height;D.x=Te/U*2-1,D.y=-(fe/pe)*2+1,E.set(D.x,D.y,1).unproject(i.object).sub(i.object.position).normalize()}function ne(R){return Math.max(i.minDistance,Math.min(i.maxDistance,R))}function ue(R){f.set(R.clientX,R.clientY)}function ce(R){k(R.clientX,R.clientX),d.set(R.clientX,R.clientY)}function Q(R){x.set(R.clientX,R.clientY)}function j(R){h.set(R.clientX,R.clientY),m.subVectors(h,f).multiplyScalar(i.rotateSpeed);const de=i.domElement;te(2*Math.PI*m.x/de.clientHeight),le(2*Math.PI*m.y/de.clientHeight),f.copy(h),i.update()}function xe(R){y.set(R.clientX,R.clientY),S.subVectors(y,d),S.y>0?O(Y(S.y)):S.y<0&&G(Y(S.y)),d.copy(y),i.update()}function ye(R){_.set(R.clientX,R.clientY),p.subVectors(_,x).multiplyScalar(i.panSpeed),W(p.x,p.y),x.copy(_),i.update()}function be(R){k(R.clientX,R.clientY),R.deltaY<0?G(Y(R.deltaY)):R.deltaY>0&&O(Y(R.deltaY)),i.update()}function Ue(R){let de=!1;switch(R.code){case i.keys.UP:R.ctrlKey||R.metaKey||R.shiftKey?le(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(0,i.keyPanSpeed),de=!0;break;case i.keys.BOTTOM:R.ctrlKey||R.metaKey||R.shiftKey?le(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(0,-i.keyPanSpeed),de=!0;break;case i.keys.LEFT:R.ctrlKey||R.metaKey||R.shiftKey?te(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(i.keyPanSpeed,0),de=!0;break;case i.keys.RIGHT:R.ctrlKey||R.metaKey||R.shiftKey?te(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):W(-i.keyPanSpeed,0),de=!0;break}de&&(R.preventDefault(),i.update())}function Oe(R){if(w.length===1)f.set(R.pageX,R.pageY);else{const de=ge(R),Re=.5*(R.pageX+de.x),Te=.5*(R.pageY+de.y);f.set(Re,Te)}}function me(R){if(w.length===1)x.set(R.pageX,R.pageY);else{const de=ge(R),Re=.5*(R.pageX+de.x),Te=.5*(R.pageY+de.y);x.set(Re,Te)}}function Le(R){const de=ge(R),Re=R.pageX-de.x,Te=R.pageY-de.y,fe=Math.sqrt(Re*Re+Te*Te);d.set(0,fe)}function v(R){i.enableZoom&&Le(R),i.enablePan&&me(R)}function L(R){i.enableZoom&&Le(R),i.enableRotate&&Oe(R)}function F(R){if(w.length==1)h.set(R.pageX,R.pageY);else{const Re=ge(R),Te=.5*(R.pageX+Re.x),fe=.5*(R.pageY+Re.y);h.set(Te,fe)}m.subVectors(h,f).multiplyScalar(i.rotateSpeed);const de=i.domElement;te(2*Math.PI*m.x/de.clientHeight),le(2*Math.PI*m.y/de.clientHeight),f.copy(h)}function J(R){if(w.length===1)_.set(R.pageX,R.pageY);else{const de=ge(R),Re=.5*(R.pageX+de.x),Te=.5*(R.pageY+de.y);_.set(Re,Te)}p.subVectors(_,x).multiplyScalar(i.panSpeed),W(p.x,p.y),x.copy(_)}function H(R){const de=ge(R),Re=R.pageX-de.x,Te=R.pageY-de.y,fe=Math.sqrt(Re*Re+Te*Te);y.set(0,fe),S.set(0,Math.pow(y.y/d.y,i.zoomSpeed)),O(S.y),d.copy(y);const U=(R.pageX+de.x)*.5,pe=(R.pageY+de.y)*.5;k(U,pe)}function ie(R){i.enableZoom&&H(R),i.enablePan&&J(R)}function re(R){i.enableZoom&&H(R),i.enableRotate&&F(R)}function M(R){i.enabled!==!1&&(w.length===0&&(i.domElement.setPointerCapture(R.pointerId),i.domElement.addEventListener("pointermove",g),i.domElement.addEventListener("pointerup",P)),Ne(R),R.pointerType==="touch"?Ce(R):q(R))}function g(R){i.enabled!==!1&&(R.pointerType==="touch"?se(R):B(R))}function P(R){Ie(R),w.length===0&&(i.domElement.releasePointerCapture(R.pointerId),i.domElement.removeEventListener("pointermove",g),i.domElement.removeEventListener("pointerup",P)),i.dispatchEvent(Lu),s=r.NONE}function q(R){let de;switch(R.button){case 0:de=i.mouseButtons.LEFT;break;case 1:de=i.mouseButtons.MIDDLE;break;case 2:de=i.mouseButtons.RIGHT;break;default:de=-1}switch(de){case Ni.DOLLY:if(i.enableZoom===!1)return;ce(R),s=r.DOLLY;break;case Ni.ROTATE:if(R.ctrlKey||R.metaKey||R.shiftKey){if(i.enablePan===!1)return;Q(R),s=r.PAN}else{if(i.enableRotate===!1)return;ue(R),s=r.ROTATE}break;case Ni.PAN:if(R.ctrlKey||R.metaKey||R.shiftKey){if(i.enableRotate===!1)return;ue(R),s=r.ROTATE}else{if(i.enablePan===!1)return;Q(R),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(go)}function B(R){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;j(R);break;case r.DOLLY:if(i.enableZoom===!1)return;xe(R);break;case r.PAN:if(i.enablePan===!1)return;ye(R);break}}function X(R){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(R.preventDefault(),i.dispatchEvent(go),be(oe(R)),i.dispatchEvent(Lu))}function oe(R){const de=R.deltaMode,Re={clientX:R.clientX,clientY:R.clientY,deltaY:R.deltaY};switch(de){case 1:Re.deltaY*=16;break;case 2:Re.deltaY*=100;break}return R.ctrlKey&&!T&&(Re.deltaY*=10),Re}function ae(R){R.key==="Control"&&(T=!0,document.addEventListener("keyup",he,{passive:!0,capture:!0}))}function he(R){R.key==="Control"&&(T=!1,document.removeEventListener("keyup",he,{passive:!0,capture:!0}))}function _e(R){i.enabled===!1||i.enablePan===!1||Ue(R)}function Ce(R){switch(we(R),w.length){case 1:switch(i.touches.ONE){case Oi.ROTATE:if(i.enableRotate===!1)return;Oe(R),s=r.TOUCH_ROTATE;break;case Oi.PAN:if(i.enablePan===!1)return;me(R),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case Oi.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;v(R),s=r.TOUCH_DOLLY_PAN;break;case Oi.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;L(R),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(go)}function se(R){switch(we(R),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;F(R),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;J(R),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;ie(R),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;re(R),i.update();break;default:s=r.NONE}}function Ge(R){i.enabled!==!1&&R.preventDefault()}function Ne(R){w.push(R.pointerId)}function Ie(R){delete $[R.pointerId];for(let de=0;de<w.length;de++)if(w[de]==R.pointerId){w.splice(de,1);return}}function we(R){let de=$[R.pointerId];de===void 0&&(de=new Ae,$[R.pointerId]=de),de.set(R.pageX,R.pageY)}function ge(R){const de=R.pointerId===w[0]?w[1]:w[0];return $[de]}i.domElement.addEventListener("contextmenu",Ge),i.domElement.addEventListener("pointerdown",M),i.domElement.addEventListener("pointercancel",P),i.domElement.addEventListener("wheel",X,{passive:!1}),document.addEventListener("keydown",ae,{passive:!0,capture:!0}),this.update()}}const IM=16777215,NM=16777215,Ph="#266f9a",ir=4,na=256,Uu=1e3,OM=1,FM=999,Iu=19,BM=26,rr=.0015,zM=200,HM=150,GM=100,VM=60;let Lh=!0;function kM(n,e={}){const{showIcosahedron:t=!1,showLatLngGrid:i=!1,loadBrandingImageMarkers:r=!1,enableInteraction:s=!0,earthTexture:a=null,onMarkerClick:o=null}=e;if(!n&&typeof DEBUG<"u"&&DEBUG)return console.error("❌ No container provided to createGlobeScene"),{cleanup:()=>{}};let l=0,c=0,u=60;const f=new uM,h=new fn(45,n.clientWidth/n.clientHeight,1,2e3);h.position.set(0,0,Iu);const m=new Eh({antialias:window.devicePixelRatio<=1,alpha:!0,powerPreference:"high-performance",stencil:!1,depth:!0,preserveDrawingBuffer:!1,failIfMajorPerformanceCaveat:!1});m.setPixelRatio(Math.min(window.devicePixelRatio,2)),m.setSize(n.clientWidth,n.clientHeight),m.setClearColor("#079",0),m.outputColorSpace=Pn,m.shadowMap.enabled=!1,m.physicallyCorrectLights=!1,m.toneMapping=kn,m.sortObjects=!1,m.autoClear=!0,m.autoClearColor=!0,m.autoClearDepth=!0,m.autoClearStencil=!0,n.appendChild(m.domElement);const x=m.domElement;x.style.position="relative";let _=null,p=null,d=null,y=null;_=new UM(h,m.domElement),_.minDistance=Iu,_.maxDistance=BM,_.enableDamping=!0,_.dampingFactor=.1,_.enablePan=!1,_.enableRotate=!0,_.enableZoom=!0,_.autoRotate=!1,_.rotateSpeed=.5,_.zoomSpeed=1;const S=window.devicePixelRatio<=2&&!/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);S&&(p=new PM(m),d=new LM(f,h),p.addPass(d),y=new oi(new Ae(n.clientWidth,n.clientHeight),f,h),y.edgeStrength=1,y.edgeGlow=5,p.addPass(y));const E=new Br;f.add(E);const D=new EM(IM,3);f.add(D);const C=new SM(NM,1.5);C.position.set(5,5,5),C.castShadow=!1,f.add(C);const w=WM(ir);E.add(w);const $=XM(ir,a);if(E.add($),t){const me=qM(ir+.1);$.add(me)}if(i){const me=YM(ir+.02,12,24);$.add(me),jM(E,ir+.5)}const T=new Ae,A=new TM,Y=[];let te=rr,le=rr,I=!1,V=!1,W=0,O=0,G=0,k=performance.now();const ne=(me,Le,v)=>me+(Le-me)*v;A.params.Mesh={threshold:.5};function ue(me){l++,me-c>=1e3&&(u=l,l=0,c=me)}function ce(me){V?(I=!1,O=1,le=rr):(G=performance.now(),I=!0,me.touches?W=me.touches[0].clientX:W=me.clientX)}function Q(me){if(I){let Le;me.touches?Le=me.touches[0].clientX:Le=me.clientX,O=Le-W,Math.abs(O)>1&&(le=Math.max(-1,Math.min(1,O/300))*.02)}}function j(me){G=performance.now()-G,I&&Math.abs(O)>zM&&G<HM&&G>GM?(le=O*7e-4,V=!0):le=rr,I=!1}function xe(me){if(!s)return;const Le=n.getBoundingClientRect();T.x=(me.clientX-Le.left)/Le.width*2-1,T.y=-((me.clientY-Le.top)/Le.height)*2+1,A.setFromCamera(T,h);const v=A.intersectObjects(Y,!1);if(v.length>0&&v[0].object.userData.isMarker){const L=v[0].object;o&&o(L.userData)}}s&&(n.addEventListener("mousedown",ce,{passive:!0}),n.addEventListener("mousemove",Q,{passive:!0}),n.addEventListener("mouseup",j,{passive:!0}),n.addEventListener("click",xe),n.addEventListener("touchstart",ce,{passive:!0}),n.addEventListener("touchmove",Q,{passive:!0}),n.addEventListener("touchend",j,{passive:!0}));let ye;const be=1e3/VM;let Ue=0;function Oe(me){ye=requestAnimationFrame(Oe);const Le=me-k;for(k=me,Ue+=Le,ue(me);Ue>=be;)V&&(le*=.97,Math.abs(le)<=rr&&(le=rr,V=!1)),Ue-=be;const v=Math.min(.25,Le/1e3);te=ne(te,le,v),Math.abs(te)<1e-5&&(te=0),(Lh||V)&&(E.rotation.y+=te),_&&_.update(),p&&S?p.render():m.render(f,h)}return Oe(performance.now()),{scene:f,camera:h,renderer:m,globe:E,addMarker:(me,Le,v,L={})=>KM(E,Y,me,Le,v,ir,L),getCurrentFps:()=>u,cleanup:()=>{ye&&cancelAnimationFrame(ye),s&&(n.removeEventListener("mousedown",ce),n.removeEventListener("mousemove",Q),n.removeEventListener("mouseup",j),n.removeEventListener("click",xe),n.removeEventListener("touchstart",ce),n.removeEventListener("touchmove",Q),n.removeEventListener("touchend",j)),m.dispose(),p&&p.dispose(),n&&m.domElement.parentNode===n&&n.removeChild(m.domElement)}}}function WM(n){const e=new Vt({transparent:!0,side:Wt,depthWrite:!1,blending:js,uniforms:{glowColor:{value:new Ye(Ph)},viewVector:{value:new N(0,0,1)},intensity:{value:.4},fadeStrength:{value:6}},vertexShader:`
      varying vec3 vNormal;
      varying vec3 vPosition;
      void main() {
    ...
    `}),t=new kt(new Tr(n*1.05,na,na),e);return t.renderOrder=OM,t}function XM(n,e=null){const t=new Ah,i=e?t.load(e):null;i&&(i.generateMipmaps=!0,i.minFilter=Sr,i.magFilter=nn,i.wrapS=rn,i.wrapT=rn);const r=new gl({color:"#ffffff",map:i,transparent:!0,opacity:1,roughness:.8,metalness:.1}),s=new Tr(n,na,na),a=new kt(s,r);return a.renderOrder=FM,a}function qM(n){return new kt(new ml(n,6),new gl({color:"#08b",wireframe:!0}))}function YM(n,e=8,t=16){const i=[];for(let a=1;a<e;a++){const o=a/e*Math.PI;for(let l=0;l<t;l++){const c=l/t*2*Math.PI,u=(l+1)/t*2*Math.PI,f=n*Math.sin(o)*Math.cos(c),h=n*Math.cos(o),m=n*Math.sin(o)*Math.sin(c),x=n*Math.sin(o)*Math.cos(u),_=n*Math.cos(o),p=n*Math.sin(o)*Math.sin(u);i.push(f,h,m,x,_,p)}}for(let a=0;a<t;a++){const o=a/t*2*Math.PI;for(let l=0;l<e;l++){const c=l/e*Math.PI,u=(l+1)/e*Math.PI,f=n*Math.sin(c)*Math.cos(o),h=n*Math.cos(c),m=n*Math.sin(c)*Math.sin(o),x=n*Math.sin(u)*Math.cos(o),_=n*Math.cos(u),p=n*Math.sin(u)*Math.sin(o);i.push(f,h,m,x,_,p)}}const r=new an;r.setAttribute("position",new bt(i,3));const s=new bh({color:16777215});return new pM(r,s)}function jM(n,e){const t=[-60,-30,0,30,60],i=[-120,-60,0,60,120];for(let r of t){const s=Nu(`${r}°`,{fontsize:32}),a=zo(r,0,e);s.position.copy(a),n.add(s)}for(let r of i){const s=Nu(`${r}°`,{fontsize:32}),a=zo(0,r,e);s.position.copy(a),n.add(s)}}function Nu(n,e={}){const t=document.createElement("canvas"),i=t.getContext("2d"),r=e.fontface||"Arial",s=e.fontsize||10;t.width=128,t.height=64,i.font=`${s}px ${r}`,i.fillStyle=e.fillStyle||Ph,i.textAlign="center",i.fillText(n,t.width/2,t.height/2);const a=new mM(t),o=new yh({map:a,transparent:!0}),l=new hM(o);return l.scale.set(1.5,.5,1),l}function zo(n,e,t){const i=(90-n)*(Math.PI/180),r=(e+180)*(Math.PI/180),s=-t*Math.sin(i)*Math.cos(r),a=t*Math.sin(i)*Math.sin(r),o=t*Math.cos(i);return new N(s,o,a)}function KM(n,e,t,i,r,s,a={}){const{color:o=16711680,size:l=.1,useBrandingImage:c=!1,imagePath:u="img/save-the-children-logo.png"}=a,f=zo(t,i,s+.05);let h;if(c){const y=new Ah().load(u),S=new ea({map:y,transparent:!0}),E=new va(.8,.8);h=new kt(E,S),h.scale.set(.4,.4,.4),h.rotation.x=-Math.PI/2}else{const d=new Tr(l,16,16),y=new gl({color:o,emissive:1118481,transparent:!0,opacity:1});h=new kt(d,y)}h.position.copy(f),h.userData={isMarker:!0,name:r,lat:t,lon:i,...a},h.renderOrder=Uu;const m=l*1,x=new Tr(m,8,8),_=new ea({visible:!1}),p=new kt(x,_);return p.position.copy(f),p.userData=h.userData,p.renderOrder=Uu,n.add(h),n.add(p),e.push(p),h}function $M(n,e,t){return function(){if(!t)return;const r=t.clientWidth,s=t.clientHeight;n.aspect=r/s,n.updateProjectionMatrix(),e.setSize(r,s)}}function Dh(n,e={}){if(!n)return()=>{};const t=kM(n,e),i=$M(t.camera,t.renderer,n);return window.addEventListener("resize",i,!1),e.addDefaultMarkers&&(t.addMarker(-16.8320044663129,-65.57997409031847,"Bolivia"),t.addMarker(16.87189,29.662979,"Sudan"),t.addMarker(31.505688716093005,34.47440122930478,"Gaza"),t.addMarker(48.93848108965053,31.488680986772465,"Ukraine"),t.addMarker(.6135656340107651,37.86454680897832,"Kenya"),t.addMarker(24.16779844515624,90.26363590901566,"Bangladesh"),t.addMarker(33.89401745043521,64.7245127621119,"Afghanistan"),t.addMarker(23.756642724639264,-102.58269351651069,"Mexico"),t.addMarker(28.6139,77.2088,"Delhi")),{cleanup:()=>{window.removeEventListener("resize",i),t.cleanup()},setRotateSphere:r=>{Lh=r},getCurrentFps:()=>t.getCurrentFps(),getQualityLevel:()=>t.getQualityLevel?t.getQualityLevel():"optimized"}}const ZM="/globe-game/assets/save-the-children-with-name-logo-DB56ayE8.png",JM="/globe-game/assets/touchIcon-CQmvcA2b.png",QM="/globe-game/assets/infoIcon-Vc_cMLpj.png",eS="/globe-game/assets/settingsIcon-BG0NaeyP.png",tS="/globe-game/assets/sample-DgWvByt9.jpg",nS="/globe-game/assets/worldMapBlue5400x2700-23wXjD1U.jpeg";function iS(){const n=document.createElement("link");n.href="https://fonts.googleapis.com/css2?family=Oswald:wght@200;300;400;500;600;700&display=swap&subset=latin,latin-ext",n.rel="stylesheet",document.head.querySelector(`link[href="${n.href}"]`)||document.head.appendChild(n)}const rS=[{code:"en",name:"English",flag:"🇺🇸"},{code:"sv",name:"Svenska",flag:"🇸🇪"},{code:"fi",name:"Suomi",flag:"🇫🇮"}];async function Ou(n){try{return(await sm(Object.assign({"../locales/en.json":()=>os(()=>import("./en-BU8qV04V.js"),[]),"../locales/fi.json":()=>os(()=>import("./fi-C3OBIIOh.js"),[]),"../locales/sv.json":()=>os(()=>import("./sv-BhK-IkgK.js"),[])}),`../locales/${n}.json`,3)).default}catch{return n!=="en"?(await os(()=>import("./en-BU8qV04V.js"),[])).default:{}}}function Fu(n){document.documentElement.lang=n;let e=document.querySelector('meta[name="language"]');e||(e=document.createElement("meta"),e.name="language",document.head.appendChild(e)),e.content=n;let t=document.querySelector('meta[http-equiv="content-language"]');t||(t=document.createElement("meta"),t.setAttribute("http-equiv","content-language"),document.head.appendChild(t)),t.content=n}async function sS(n,e,t,i,r,s){if(!n.value||!e.value||!t.value||i.value)return;i.value=!0;const a=e.value.getBoundingClientRect(),o=t.value.getBoundingClientRect();r.value=!0,await Jo();const l=e.value.getBoundingClientRect(),c=t.value.getBoundingClientRect(),u=a.left-l.left,f=a.top-l.top,h=o.left-c.left,m=o.top-c.top;e.value.style.transform=`translate(${u}px, ${f}px)`,t.value.style.transform=`translate(${h}px, ${m}px)`,e.value.offsetHeight,e.value.style.transition="transform 0.8s ease-out",t.value.style.transition="transform 0.8s ease-out, font-size 0.8s ease-out",e.value.style.transform="translate(0, 0)",t.value.style.transform="translate(0, 0)",setTimeout(()=>{e.value&&t.value&&(e.value.style.transition="",e.value.style.transform="",t.value.style.transition="",t.value.style.transform=""),i.value=!1,s.value=!0},800)}async function aS(n,e,t,i,r,s){if(!n.value||!e.value||!t.value||i.value)return;s.value=!1,i.value=!0;const a=e.value.getBoundingClientRect(),o=t.value.getBoundingClientRect();r.value=!1,await Jo();const l=e.value.getBoundingClientRect(),c=t.value.getBoundingClientRect(),u=a.left-l.left,f=a.top-l.top,h=o.left-c.left,m=o.top-c.top;e.value.style.transform=`translate(${u}px, ${f}px)`,t.value.style.transform=`translate(${h}px, ${m}px)`,e.value.offsetHeight,e.value.style.transition="transform 0.8s ease-out",t.value.style.transition="transform 0.8s ease-out",e.value.style.transform="translate(0, 0)",t.value.style.transform="translate(0, 0)",setTimeout(()=>{e.value&&t.value&&(e.value.style.transition="",e.value.style.transform="",t.value.style.transition="",t.value.style.transform=""),i.value=!1},800)}function oS(){iS();const n=At(null),e=At(null),t=At(null),i=At(null),r=At(null),s=At(!1),a=At(!1),o=At(!1),l=At(!1),c=At(!1),u=At(!1),f=At(!1);let h=null;const m=At(localStorage.getItem("selectedLanguage")||"en"),x=At({});let _=null,p=null,d=6e4;const y={logoUrl:ZM,touchImgUrl:JM,infoImgUrl:QM,settingsImgUrl:eS,quizQuestionImg:At(tS),earthTextureUrl:nS},S=O=>x.value[O]||O,E=At({title:"",question:"",description:"",details:"",optionA:"",optionB:"",optionC:"",optionD:"",mediaUrl:""});async function D(O){m.value=O,localStorage.setItem("selectedLanguage",O),x.value=await Ou(O),Fu(O)}function C(){(l.value||!c.value&&!u.value)&&(l.value=!l.value)}function w(){c.value&&!u.value&&aS(e,t,i,u,c,f),clearTimeout(p),p=setTimeout(()=>{!c.value&&!u.value&&(s.value=!1,a.value=!1,l.value=!1,A(),sS(e,t,i,u,c,f))},d)}function $(){(s.value||!c.value&&!u.value)&&(s.value=!s.value)}function T(){(a.value||!c.value&&!u.value)&&(a.value=!a.value)}function A(){o.value=!1,h(!0)}async function Y(O,G){try{const ne=await(await fetch(`/data/${G}-quiz.json`)).json();console.log(ne),console.log("city title:",ne[O].title),ne[O]?(E.value={title:ne[O].title||"",question:ne[O].question||"",description:ne[O].description||"",details:ne[O].details||"",optionA:ne[O].optionA||"",optionB:ne[O].optionB||"",optionC:ne[O].optionC||"",optionD:ne[O].optionD||"",mediaUrl:ne[O].mediaUrl||""},o.value=!0,h&&h(!1)):console.warn(`No content found for city: ${O}`)}catch(k){console.error("Error loading overlay data:",k)}}function te(O){return/\.(mp4|webm|ogg)$/i.test(O)}function le(O){return console.log("isYouTube():",O),/youtu\.?be/.test(O)}function I(O){return console.log("getYouTubeEmbedUrl():",O),`https://www.youtube.com/embed/${V(O)}`}function V(O){console.log("extractYouTubeId():",O);const G=/^.*(?:youtu\.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/,k=O.match(G);return k&&k[1].length===11?k[1]:null}function W(O){if(console.log("getImageSrc():",O),!O||typeof O!="string")return console.warn("Invalid image URL:",O),"";if(/^https?:\/\//.test(O))return console.log("External image URL:",O),O;const G=`img/${O}`;return console.log("Local image URL:",G),G}return vf(async()=>{x.value=await Ou(m.value),Fu(m.value);const O=n.value;try{_=Dh(O,{addDefaultMarkers:!0,enableInteraction:!0,earthTexture:y.earthTextureUrl,onMarkerClick:G=>{console.log("Marker clicked:",G),Y(G.name,m.value)}})}catch(G){console.error("Error setting up Three.js scene:",G)}h=_.setRotateSphere,w()}),xf(()=>{console.log("Component unmounting"),clearTimeout(p),_&&_()}),{threeContainer:n,menuBarRef:e,logoRef:t,titleRef:i,touchSwipeHintRef:r,showInfo:s,showSettings:a,sphereOverlay:o,showLanguageSelector:l,isExpanded:c,isAnimating:u,isBreathing:f,currentLanguage:m,...y,availableLanguages:rS,overlayData:E,t:S,changeLanguage:D,toggleLanguage:C,handleUserActivity:w,toggleInfo:$,toggleSettings:T,openSphereOverlay:Y,closeSphereOverlay:A,isVideo:te,isYouTube:le,getYouTubeEmbedUrl:I,extractYouTubeId:V,getImageSrc:W}}const lS=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},cS={name:"HapticButton",props:{variant:{type:String,default:"default",validator:n=>["default","success","danger","warning","info"].includes(n)},size:{type:String,default:"medium",validator:n=>["small","medium","large"].includes(n)},color:{type:String,default:null},disabled:{type:Boolean,default:!1},hapticFeedback:{type:Boolean,default:!0},successDuration:{type:Number,default:1e3},selected:{type:Boolean,default:!1}},data(){return{showSuccess:!1,isPressed:!1}},computed:{buttonClasses(){return["haptic-button",`haptic-button--${this.variant}`,`haptic-button--${this.size}`,{"haptic-button--pressed":this.isPressed,"haptic-button--success":this.showSuccess||this.selected,"haptic-button--disabled":this.disabled}]},buttonStyles(){const n={};return this.color&&!this.disabled&&(n.background=this.color,n.color=this.getContrastColor(this.color)),n}},methods:{handleClick(n){this.disabled||(this.hapticFeedback&&navigator.vibrate&&navigator.vibrate(50),this.triggerSuccess(),this.$emit("click",n))},handleTouchStart(){this.disabled||(this.isPressed=!0)},handleTouchEnd(){this.isPressed=!1},handleMouseDown(){this.disabled||(this.isPressed=!0)},handleMouseUp(){this.isPressed=!1},handleMouseLeave(){this.isPressed=!1},triggerSuccess(){this.showSuccess=!0,setTimeout(()=>{this.showSuccess=!1},this.successDuration)},getContrastColor(n){const e=n.replace("#",""),t=parseInt(e.substr(0,2),16),i=parseInt(e.substr(2,2),16),r=parseInt(e.substr(4,2),16);return(.299*t+.587*i+.114*r)/255>.5?"#000000":"#ffffff"}}},uS=["disabled"],fS={key:0,class:"success-icon"};function hS(n,e,t,i,r,s){return Et(),Yt("button",{class:_n(s.buttonClasses),disabled:t.disabled,style:oa(s.buttonStyles),onClick:e[0]||(e[0]=(...a)=>s.handleClick&&s.handleClick(...a)),onTouchstart:e[1]||(e[1]=(...a)=>s.handleTouchStart&&s.handleTouchStart(...a)),onTouchend:e[2]||(e[2]=(...a)=>s.handleTouchEnd&&s.handleTouchEnd(...a)),onMousedown:e[3]||(e[3]=(...a)=>s.handleMouseDown&&s.handleMouseDown(...a)),onMouseup:e[4]||(e[4]=(...a)=>s.handleMouseUp&&s.handleMouseUp(...a)),onMouseleave:e[5]||(e[5]=(...a)=>s.handleMouseLeave&&s.handleMouseLeave(...a))},[We("span",{class:_n(["button-text",{"text-hidden":r.showSuccess}])},[Vd(n.$slots,"default",{},void 0)],2),r.showSuccess?(Et(),Yt("span",fS,"✓")):ei("",!0)],46,uS)}const Or=lS(cS,[["render",hS],["__scopeId","data-v-f43bc0f3"]]),dS=["src"],pS=["src"],mS={class:"sidebar-icons"},gS=["title"],_S=["src","title"],vS=["src","title"],xS={key:0,class:"overlay"},MS={class:"overlay-content info-container"},SS={class:"info-menu"},ES={class:"info-content"},yS={key:0},TS={key:1},bS={key:1,class:"overlay"},AS={class:"overlay-content"},wS={key:2,class:"overlay"},RS={class:"overlay-content language-selector"},CS={class:"language-options"},PS={key:3,class:"sphere-overlay"},LS={class:"sphere-content"},DS={class:"content"},US={class:"text"},IS={class:"buttons"},NS={class:"media"},OS=["src"],FS=["src"],BS=["src","alt"],zS={__name:"App",setup(n){const e=document.getElementById("globe-container");Dh(e,{showIcosahedron:!0,showLatLngGrid:!0,addDefaultMarkers:!0,enableInteraction:!0,onMarkerClick:G=>{console.log("Clicked marker:",G.name)}});const t=At("about");function i(G){t.value=G}const{threeContainer:r,menuBarRef:s,logoRef:a,titleRef:o,touchSwipeHintRef:l,showSettingsButton:c,showInfo:u,showSettings:f,sphereOverlay:h,showLanguageSelector:m,isExpanded:x,isBreathing:_,currentLanguage:p,logoUrl:d,touchImgUrl:y,infoImgUrl:S,settingsImgUrl:E,availableLanguages:D,overlayData:C,t:w,changeLanguage:$,toggleLanguage:T,handleUserActivity:A,toggleInfo:Y,toggleSettings:te,closeSphereOverlay:le,isVideo:I,isYouTube:V,getYouTubeEmbedUrl:W,getImageSrc:O}=oS();return(G,k)=>{var ne,ue,ce,Q;return Et(),Yt("div",{id:"landing",onMousemove:k[9]||(k[9]=(...j)=>Ee(A)&&Ee(A)(...j)),onTouchstart:k[10]||(k[10]=(...j)=>Ee(A)&&Ee(A)(...j)),onKeydown:k[11]||(k[11]=(...j)=>Ee(A)&&Ee(A)(...j)),onClick:k[12]||(k[12]=(...j)=>Ee(A)&&Ee(A)(...j)),tabindex:"0"},[We("div",{class:_n(["menu-bar",{expanded:Ee(x)}]),ref_key:"menuBarRef",ref:s},[We("img",{src:Ee(d),class:"logo",ref_key:"logoRef",ref:a},null,8,dS),We("h1",{class:_n(["title",{breathing:Ee(_)}]),ref_key:"titleRef",ref:o},gt(Ee(w)("title")),3),We("div",{id:"touchSwipeHint",class:_n(["touch-screen-hint",{show:Ee(x)}])},[We("img",{id:"touchIcon",src:Ee(y),alt:"Touch screen to play"},null,8,pS),We("span",{ref_key:"touchSwipeHintRef",ref:l},gt(Ee(w)("touchSwipeHint")),513)],2)],2),We("div",{id:"globe-container",ref_key:"threeContainer",ref:r,class:"three-container"},null,512),We("div",mS,[We("button",{onClick:k[0]||(k[0]=(...j)=>Ee(T)&&Ee(T)(...j)),title:Ee(w)("selectLanguage")},gt(Ee(p)),9,gS),We("img",{onClick:k[1]||(k[1]=(...j)=>Ee(Y)&&Ee(Y)(...j)),src:Ee(S),title:Ee(w)("info")},null,8,_S),Ee(c)?(Et(),Yt("img",{key:0,onClick:k[2]||(k[2]=(...j)=>Ee(te)&&Ee(te)(...j)),src:Ee(E),title:Ee(w)("settings")},null,8,vS)):ei("",!0)]),Ee(u)?(Et(),Yt("div",xS,[We("div",MS,[We("button",{class:"close",onClick:k[3]||(k[3]=(...j)=>Ee(Y)&&Ee(Y)(...j))},"✖"),We("div",SS,[We("button",{onClick:k[4]||(k[4]=j=>i("about")),class:_n({active:t.value==="about"})},"About",2),We("button",{onClick:k[5]||(k[5]=j=>i("licenses")),class:_n({active:t.value==="licenses"})},"Licenses",2)]),We("div",ES,[t.value==="about"?(Et(),Yt("div",yS,[We("p",null,gt(Ee(w)("aboutContent")),1)])):ei("",!0),t.value==="licenses"?(Et(),Yt("div",TS,[We("p",null,gt(Ee(w)("mitLicense")),1),We("p",null,gt(Ee(w)("mitCopyright")),1),We("p",null,gt(Ee(w)("mitLicenseText")),1)])):ei("",!0)])])])):ei("",!0),Ee(f)?(Et(),Yt("div",bS,[We("div",AS,[We("button",{class:"close",onClick:k[6]||(k[6]=(...j)=>Ee(te)&&Ee(te)(...j))},"✖"),We("h3",null,gt(Ee(w)("settingsTitle")),1),We("p",null,gt(Ee(w)("settingsContent")),1)])])):ei("",!0),Ee(m)?(Et(),Yt("div",wS,[We("div",RS,[We("button",{class:"close",onClick:k[7]||(k[7]=j=>m.value=!1)},"✖"),We("h3",null,gt(Ee(w)("selectLanguage")),1),We("div",CS,[(Et(!0),Yt(tn,null,Gd(Ee(D),j=>(Et(),qs(Or,{key:j.code,onClick:xe=>Ee($)(j.code),class:_n([{active:Ee(p)===j.code},"language-option"])},{default:ar(()=>[or(gt(j.name),1)]),_:2},1032,["onClick","class"]))),128))])])])):ei("",!0),Ee(h)?(Et(),Yt("div",PS,[We("div",LS,[We("button",{class:"close",onClick:k[8]||(k[8]=(...j)=>Ee(le)&&Ee(le)(...j))},"✖"),We("h1",null,gt((ne=Ee(C))==null?void 0:ne.title),1),We("div",DS,[We("div",US,[We("p",null,gt((ue=Ee(C))==null?void 0:ue.question),1),We("p",null,gt((ce=Ee(C))==null?void 0:ce.description)+" "+gt((Q=Ee(C))==null?void 0:Q.details),1),We("div",IS,[$t(Or,null,{default:ar(()=>{var j;return[or(gt((j=Ee(C))==null?void 0:j.optionA),1)]}),_:1}),$t(Or,null,{default:ar(()=>{var j;return[or(gt((j=Ee(C))==null?void 0:j.optionB),1)]}),_:1}),$t(Or,null,{default:ar(()=>{var j;return[or(gt((j=Ee(C))==null?void 0:j.optionC),1)]}),_:1}),$t(Or,null,{default:ar(()=>{var j;return[or(gt((j=Ee(C))==null?void 0:j.optionD),1)]}),_:1})])]),We("div",NS,[Ee(V)(Ee(C).mediaUrl)?(Et(),Yt("iframe",{key:0,width:"560",height:"315",src:Ee(W)(Ee(C).mediaUrl),title:"YouTube video player",frameborder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowfullscreen:""},null,8,OS)):Ee(I)(Ee(C).mediaUrl)?(Et(),Yt("video",{key:1,controls:"",src:Ee(C).mediaUrl},null,8,FS)):(Et(),Yt("img",{key:2,src:Ee(O)(Ee(C).mediaUrl),alt:Ee(C).title},null,8,BS))])])])])):ei("",!0)],32)}}};em(zS).mount("#app");
